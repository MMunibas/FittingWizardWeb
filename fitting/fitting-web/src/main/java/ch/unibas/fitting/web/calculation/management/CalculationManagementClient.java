...
public class CalculationManagementClient {
    ...
    public StartResponse spawnTask(String title, String username, NavigationInfo navigationInfo, StartDefinition... starts){
    ...
    public void cancelTask(String taskId) {
        runAsync(()->{
            ...
            while(!getTaskInfo(taskId).executions.stream().allMatch(ExecutionProgress::isTerminated)) {
                try {
                    Thread.sleep(1);
