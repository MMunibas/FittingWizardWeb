(function(a,m){"object"===typeof module&&"object"===typeof module.exports?module.exports=a.document?m(a,!0):function(a){if(!a.document)throw Error("jQuery requires a window with a document");return m(a)}:m(a)})("undefined"!==typeof window?window:this,function(a,m){function j(f){var w=f.length,a=g.type(f);return"function"===a||g.isWindow(f)?!1:1===f.nodeType&&w?!0:"array"===a||0===w||"number"===typeof w&&0<w&&w-1 in f}function h(f,w,a){if(g.isFunction(w))return g.grep(f,function(f,g){return!!w.call(f,
...
"complete"===y.readyState)l(),g.ready()}function s(f,w,a){if(void 0===a&&1===f.nodeType)if(a="data-"+w.replace(Wc,"-$1").toLowerCase(),a=f.getAttribute(a),"string"===typeof a){try{a="true"===a?!0:"false"===a?!1:"null"===a?null:+a+""===a?+a:Xc.test(a)?g.parseJSON(a):a}catch(z){}g.data(f,w,a)}else a=void 0;return a}function u(f){for(var a in f)if(!("data"===a&&g.isEmptyObject(f[a]))&&"toJSON"!==a)return!1;return!0}function b(f,a,p,z){if(g.acceptData(f)){var b=g.expando,c=f.nodeType,d=c?g.cache:f,n=
c?f[b]:f[b]&&b;if(n&&d[n]&&(z||d[n].data)||!(void 0===p&&"string"===typeof a)){n||(n=c?f[b]=k.pop()||g.guid++:b);d[n]||(d[n]=c?{}:{toJSON:g.noop});if("object"===typeof a||"function"===typeof a)z?d[n]=g.extend(d[n],a):d[n].data=g.extend(d[n].data,a);f=d[n];z||(f.data||(f.data={}),f=f.data);void 0!==p&&(f[g.camelCase(a)]=p);"string"===typeof a?(p=f[a],null==p&&(p=f[g.camelCase(a)])):p=f;return p}}}function c(f,a,p){if(g.acceptData(f)){var z,b,c=f.nodeType,k=c?g.cache:f,d=c?f[g.expando]:g.expando;if(k[d]){if(a&&
(z=p?k[d]:k[d].data)){g.isArray(a)?a=a.concat(g.map(a,g.camelCase)):a in z?a=[a]:(a=g.camelCase(a),a=a in z?[a]:a.split(" "));for(b=a.length;b--;)delete z[a[b]];if(p?!u(z):!g.isEmptyObject(z))return}if(!p&&(delete k[d].data,!u(k[d])))return;c?g.cleanData([f],!0):v.deleteExpando||k!=k.window?delete k[d]:k[d]=null}}}function d(){return!0}function t(){return!1}function F(){try{return y.activeElement}catch(f){}}function C(f){var a=mc.split("|");f=f.createDocumentFragment();if(f.createElement)for(;a.length;)f.createElement(a.pop());
return f}function K(f,a){var p,z,b=0,c=typeof f.getElementsByTagName!==ka?f.getElementsByTagName(a||"*"):typeof f.querySelectorAll!==ka?f.querySelectorAll(a||"*"):void 0;if(!c){c=[];for(p=f.childNodes||f;null!=(z=p[b]);b++)!a||g.nodeName(z,a)?c.push(z):g.merge(c,K(z,a))}return void 0===a||a&&g.nodeName(f,a)?g.merge([f],c):c}function rb(f){Mb.test(f.type)&&(f.defaultChecked=f.checked)}function Ya(f,a){return g.nodeName(f,"table")&&g.nodeName(11!==a.nodeType?a:a.firstChild,"tr")?f.getElementsByTagName("tbody")[0]||
f.appendChild(f.ownerDocument.createElement("tbody")):f}function Ea(f){f.type=(null!==g.find.attr(f,"type"))+"/"+f.type;return f}function U(f){var a=Yc.exec(f.type);a?f.type=a[1]:f.removeAttribute("type");return f}function Q(f,a){for(var p,z=0;null!=(p=f[z]);z++)g._data(p,"globalEval",!a||g._data(a[z],"globalEval"))}function Fa(f,a){if(1===a.nodeType&&g.hasData(f)){var p,z,b;z=g._data(f);var c=g._data(a,z),k=z.events;if(k)for(p in delete c.handle,c.events={},k){z=0;for(b=k[p].length;z<b;z++)g.event.add(a,
p,k[p][z])}c.data&&(c.data=g.extend({},c.data))}}function Pa(f,w){var p=g(w.createElement(f)).appendTo(w.body),z=a.getDefaultComputedStyle?a.getDefaultComputedStyle(p[0]).display:g.css(p[0],"display");p.detach();return z}function db(f){var a=y,p=nc[f];if(!p){p=Pa(f,a);if("none"===p||!p)eb=(eb||g("<iframe frameborder='0' width='0' height='0'/>")).appendTo(a.documentElement),a=(eb[0].contentWindow||eb[0].contentDocument).document,a.write(),a.close(),p=Pa(f,a),eb.detach();nc[f]=p}return p}function fb(f,
a){return{get:function(){var p=f();if(null!=p)if(p)delete this.get;else return(this.get=a).apply(this,arguments)}}}function gb(f,a){if(a in f)return a;for(var p=a.charAt(0).toUpperCase()+a.slice(1),z=a,b=oc.length;b--;)if(a=oc[b]+p,a in f)return a;return z}function va(f,a){for(var p,z,b,c=[],k=0,d=f.length;k<d;k++)if(z=f[k],z.style)if(c[k]=g._data(z,"olddisplay"),p=z.style.display,a)!c[k]&&"none"===p&&(z.style.display=""),""===z.style.display&&hb(z)&&(c[k]=g._data(z,"olddisplay",db(z.nodeName)));
else if(!c[k]&&(b=hb(z),p&&"none"!==p||!b))g._data(z,"olddisplay",b?p:g.css(z,"display"));for(k=0;k<d;k++)if(z=f[k],z.style&&(!a||"none"===z.style.display||""===z.style.display))z.style.display=a?c[k]||"":"none";return f}function la(f,a,p){return(f=Zc.exec(a))?Math.max(0,f[1]-(p||0))+(f[2]||"px"):a}function x(f,a,p,z,b){a=p===(z?"border":"content")?4:"width"===a?1:0;for(var c=0;4>a;a+=2)"margin"===p&&(c+=g.css(f,p+Qa[a],!0,b)),z?("content"===p&&(c-=g.css(f,"padding"+Qa[a],!0,b)),"margin"!==p&&(c-=
g.css(f,"border"+Qa[a]+"Width",!0,b))):(c+=g.css(f,"padding"+Qa[a],!0,b),"padding"!==p&&(c+=g.css(f,"border"+Qa[a]+"Width",!0,b)));return c}function Z(f,a,p){var b=!0,c="width"===a?f.offsetWidth:f.offsetHeight,k=Ra(f),d=v.boxSizing()&&"border-box"===g.css(f,"boxSizing",!1,k);if(0>=c||null==c){c=Sa(f,a,k);if(0>c||null==c)c=f.style[a];if(sb.test(c))return c;b=d&&(v.boxSizingReliable()||c===f.style[a]);c=parseFloat(c)||0}return c+x(f,a,p||(d?"border":"content"),b,k)+"px"}function L(f,a,p,b,g){return new L.prototype.init(f,
a,p,b,g)}function fa(){setTimeout(function(){Za=void 0});return Za=g.now()}function O(f,a){var p,b={height:f},g=0;for(a=a?1:0;4>g;g+=2-a)p=Qa[g],b["margin"+p]=b["padding"+p]=f;a&&(b.opacity=b.width=f);return b}function wa(f,a,p){for(var b,g=(ib[a]||[]).concat(ib["*"]),c=0,k=g.length;c<k;c++)if(b=g[c].call(p,a,f))return b}function jb(f,a,p){var b,c,k=0,d=tb.length,n=g.Deferred().always(function(){delete e.elem}),e=function(){if(c)return!1;for(var a=Za||fa(),a=Math.max(0,r.startTime+r.duration-a),w=
...
!0;w<p;w++)r.tweens[w].run(1);a?n.resolveWith(f,[r,a]):n.rejectWith(f,[r,a]);return this}});a=r.props;p=r.opts.specialEasing;var h,t,l,j;for(b in a)if(h=g.camelCase(b),t=p[h],l=a[b],g.isArray(l)&&(t=l[1],l=a[b]=l[0]),b!==h&&(a[h]=l,delete a[b]),(j=g.cssHooks[h])&&"expand"in j)for(b in l=j.expand(l),delete a[h],l)b in a||(a[b]=l[b],p[b]=t);else p[h]=t;for(;k<d;k++)if(b=tb[k].call(r,f,a,r.opts))return b;g.map(a,wa,r);g.isFunction(r.opts.start)&&r.opts.start.call(f,r);g.fx.timer(g.extend(e,{elem:f,anim:r,
...
new a.XMLHttpRequest}catch(w){}}function aa(){try{return new a.XMLHttpRequest}catch(f){}}function V(f){return g.isWindow(f)?f:9===f.nodeType?f.defaultView||f.parentWindow:!1}var k=[],n=k.slice,r=k.concat,A=k.push,G=k.indexOf,P={},bd=P.toString,za=P.hasOwnProperty,Ob="".trim,v={},g=function(f,a){return new g.fn.init(f,a)},cd=/^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g,dd=/^-ms-/,ed=/-([\da-z])/gi,fd=function(f,a){return a.toUpperCase()};g.fn=g.prototype={jquery:"1.11.0",constructor:g,selector:"",length:0,
...
this.length;f=+f+(0>f?a:0);return this.pushStack(0<=f&&f<a?[this[f]]:[])},end:function(){return this.prevObject||this.constructor(null)},push:A,sort:k.sort,splice:k.splice};g.extend=g.fn.extend=function(){var f,a,p,b,c,k=arguments[0]||{},d=1,n=arguments.length,e=!1;"boolean"===typeof k&&(e=k,k=arguments[d]||{},d++);"object"!==typeof k&&!g.isFunction(k)&&(k={});d===n&&(k=this,d--);for(;d<n;d++)if(null!=(c=arguments[d]))for(b in c)f=k[b],p=c[b],k!==p&&(e&&p&&(g.isPlainObject(p)||(a=g.isArray(p)))?(a?
...
return!0},isPlainObject:function(f){var a;if(!f||"object"!==g.type(f)||f.nodeType||g.isWindow(f))return!1;try{if(f.constructor&&!za.call(f,"constructor")&&!za.call(f.constructor.prototype,"isPrototypeOf"))return!1}catch(p){return!1}if(v.ownLast)for(a in f)return za.call(f,a);for(a in f);return void 0===a||za.call(f,a)},type:function(f){return null==f?f+"":"object"===typeof f||"function"===typeof f?P[bd.call(f)]||"object":typeof f},globalEval:function(f){f&&g.trim(f)&&(a.execScript||function(f){a.eval.call(a,
f)})(f)},camelCase:function(f){return f.replace(dd,"ms-").replace(ed,fd)},nodeName:function(f,a){return f.nodeName&&f.nodeName.toLowerCase()===a.toLowerCase()},each:function(f,a,p){var b,g=0,c=f.length;b=j(f);if(p)if(b)for(;g<c&&!(b=a.apply(f[g],p),!1===b);g++);else for(g in f){if(b=a.apply(f[g],p),!1===b)break}else if(b)for(;g<c&&!(b=a.call(f[g],g,f[g]),!1===b);g++);else for(g in f)if(b=a.call(f[g],g,f[g]),!1===b)break;return f},trim:Ob&&!Ob.call("\ufeff\u00a0")?function(f){return null==f?"":Ob.call(f)}:
function(f){return null==f?"":(f+"").replace(cd,"")},makeArray:function(f,a){var p=a||[];null!=f&&(j(Object(f))?g.merge(p,"string"===typeof f?[f]:f):A.call(p,f));return p},inArray:function(f,a,p){var b;if(a){if(G)return G.call(a,f,p);b=a.length;for(p=p?0>p?Math.max(0,b+p):p:0;p<b;p++)if(p in a&&a[p]===f)return p}return-1},merge:function(f,a){for(var p=+a.length,b=0,g=f.length;b<p;)f[g++]=a[b++];if(p!==p)for(;void 0!==a[b];)f[g++]=a[b++];f.length=g;return f},grep:function(f,a,p){for(var b=[],g=0,c=
f.length,k=!p;g<c;g++)p=!a(f[g],g),p!==k&&b.push(f[g]);return b},map:function(f,a,p){var b,g=0,c=f.length,k=[];if(j(f))for(;g<c;g++)b=a(f[g],g,p),null!=b&&k.push(b);else for(g in f)b=a(f[g],g,p),null!=b&&k.push(b);return r.apply([],k)},guid:1,proxy:function(f,a){var p,b;"string"===typeof a&&(b=f[a],a=f,f=b);if(g.isFunction(f))return p=n.call(arguments,2),b=function(){return f.apply(a||this,p.concat(n.call(arguments)))},b.guid=f.guid=f.guid||g.guid++,b},now:function(){return+new Date},support:v});
g.each("Boolean Number String Function Array Date RegExp Object Error".split(" "),function(f,a){P["[object "+a+"]"]=a.toLowerCase()});var Pb=a,E=function(f,a,p,b){var g,c,k,d,n;(a?a.ownerDocument||a:W)!==R&&na(a);a=a||R;p=p||[];if(!f||"string"!==typeof f)return p;if(1!==(d=a.nodeType)&&9!==d)return[];if(X&&!b){if(g=gd.exec(f))if(k=g[1])if(9===d)if((c=a.getElementById(k))&&c.parentNode){if(c.id===k)return p.push(c),p}else return p;else{if(a.ownerDocument&&(c=a.ownerDocument.getElementById(k))&&ra(a,
c)&&c.id===k)return p.push(c),p}else{if(g[2])return Ga.apply(p,a.getElementsByTagName(f)),p;if((k=g[3])&&I.getElementsByClassName&&a.getElementsByClassName)return Ga.apply(p,a.getElementsByClassName(k)),p}if(I.qsa&&(!S||!S.test(f))){c=g=M;k=a;n=9===d&&f;if(1===d&&"object"!==a.nodeName.toLowerCase()){d=sa(f);(g=a.getAttribute("id"))?c=g.replace(hd,"\\$&"):a.setAttribute("id",c);c="[id='"+c+"'] ";for(k=d.length;k--;)d[k]=c+vb(d[k]);k=Qb.test(f)&&ga(a.parentNode)||a;n=d.join(",")}if(n)try{return Ga.apply(p,
k.querySelectorAll(n)),p}catch(e){}finally{g||a.removeAttribute("id")}}}var r;a:{f=f.replace(wb,"$1");c=sa(f);if(!b&&1===c.length){g=c[0]=c[0].slice(0);if(2<g.length&&"ID"===(r=g[0]).type&&I.getById&&9===a.nodeType&&X&&H.relative[g[1].type]){a=(H.find.ID(r.matches[0].replace(Ha,Ia),a)||[])[0];if(!a){r=p;break a}f=f.slice(g.shift().value.length)}for(d=xb.needsContext.test(f)?0:g.length;d--;){r=g[d];if(H.relative[k=r.type])break;if(k=H.find[k])if(b=k(r.matches[0].replace(Ha,Ia),Qb.test(g[0].type)&&
...
a},pc=function(f,a){var p=a&&f,b=p&&1===f.nodeType&&1===a.nodeType&&(~a.sourceIndex||ha)-(~f.sourceIndex||ha);if(b)return b;if(p)for(;p=p.nextSibling;)if(p===a)return-1;return f?1:-1},id=function(f){return function(a){return"input"===a.nodeName.toLowerCase()&&a.type===f}},jd=function(f){return function(a){var p=a.nodeName.toLowerCase();return("input"===p||"button"===p)&&a.type===f}},ta=function(f){return oa(function(a){a=+a;return oa(function(p,b){for(var g,c=f([],p.length,a),k=c.length;k--;)if(p[g=
c[k]])p[g]=!(b[g]=p[g])})})},ga=function(f){return f&&typeof f.getElementsByTagName!==T&&f},qc=function(){},sa=function(f,a){var p,b,g,c,k,d,n;if(k=Ja[f+" "])return a?0:k.slice(0);k=f;d=[];for(n=H.preFilter;k;){if(!p||(b=kd.exec(k)))b&&(k=k.slice(b[0].length)||k),d.push(g=[]);p=!1;if(b=ld.exec(k))p=b.shift(),g.push({value:p,type:b[0].replace(wb," ")}),k=k.slice(p.length);for(c in H.filter)if((b=xb[c].exec(k))&&(!n[c]||(b=n[c](b))))p=b.shift(),g.push({value:p,type:c,matches:b}),k=k.slice(p.length);
if(!p)break}return a?k.length:k?E.error(f):Ja(f,d).slice(0)},vb=function(f){for(var a=0,p=f.length,b="";a<p;a++)b+=f[a].value;return b},Tb=function(f,a,p){var b=a.dir,g=p&&"parentNode"===b,c=md++;return a.first?function(a,p,w){for(;a=a[b];)if(1===a.nodeType||g)return f(a,p,w)}:function(a,p,w){var k,d,n=[ba,c];if(w)for(;a=a[b];){if((1===a.nodeType||g)&&f(a,p,w))return!0}else for(;a=a[b];)if(1===a.nodeType||g){d=a[M]||(a[M]={});if((k=d[b])&&k[0]===ba&&k[1]===c)return n[2]=k[2];d[b]=n;if(n[2]=f(a,p,
w))return!0}}},Ub=function(f){return 1<f.length?function(a,p,b){for(var g=f.length;g--;)if(!f[g](a,p,b))return!1;return!0}:f[0]},Ta=function(f,a,p,b,g){for(var c,k=[],d=0,n=f.length,e=null!=a;d<n;d++)if(c=f[d])if(!p||p(c,b,g))k.push(c),e&&a.push(d);return k},Vb=function(f,a,p,b,g,c){b&&!b[M]&&(b=Vb(b));g&&!g[M]&&(g=Vb(g,c));return oa(function(c,k,d,n){var e,r,ea=[],l=[],h=k.length,t;if(!(t=c)){t=a||"*";for(var j=d.nodeType?[d]:d,B=[],A=0,T=j.length;A<T;A++)E(t,j[A],B);t=B}t=f&&(c||!a)?Ta(t,ea,f,d,
n):t;j=p?g||(c?f:h||b)?[]:k:t;p&&p(t,j,d,n);if(b){e=Ta(j,l);b(e,[],d,n);for(d=e.length;d--;)if(r=e[d])j[l[d]]=!(t[l[d]]=r)}if(c){if(g||f){if(g){e=[];for(d=j.length;d--;)if(r=j[d])e.push(t[d]=r);g(null,j=[],e,n)}for(d=j.length;d--;)if((r=j[d])&&-1<(e=g?Ua.call(c,r):ea[d]))c[e]=!(k[e]=r)}}else j=Ta(j===k?j.splice(h,j.length):j),g?g(null,k,j,n):Ga.apply(k,j)})},Wb=function(f){var a,p,b,g=f.length,c=H.relative[f[0].type];p=c||H.relative[" "];for(var k=c?1:0,d=Tb(function(f){return f===a},p,!0),n=Tb(function(f){return-1<
Ua.call(a,f)},p,!0),e=[function(f,p,b){return!c&&(b||p!==Aa)||((a=p).nodeType?d(f,p,b):n(f,p,b))}];k<g;k++)if(p=H.relative[f[k].type])e=[Tb(Ub(e),p)];else{p=H.filter[f[k].type].apply(null,f[k].matches);if(p[M]){for(b=++k;b<g&&!H.relative[f[b].type];b++);return Vb(1<k&&Ub(e),1<k&&vb(f.slice(0,k-1).concat({value:" "===f[k-2].type?"*":""})).replace(wb,"$1"),p,k<b&&Wb(f.slice(k,b)),b<g&&Wb(f=f.slice(b)),b<g&&vb(f))}e.push(p)}return Ub(e)},Ba,I,H,Ka,rc,$a,Aa,qa,Ca,na,R,ia,X,S,ca,La,ra,M="sizzle"+-new Date,
...
function(a,b,p){var w,e,r,j,t;b=k!==d?"nextSibling":"previousSibling";var l=a.parentNode,h=n&&a.nodeName.toLowerCase();p=!p&&!n;if(l){if(k){for(;b;){for(e=a;e=e[b];)if(n?e.nodeName.toLowerCase()===h:1===e.nodeType)return!1;t=b="only"===f&&!t&&"nextSibling"}return!0}t=[d?l.firstChild:l.lastChild];if(d&&p){p=l[M]||(l[M]={});w=p[f]||[];j=w[0]===ba&&w[1];r=w[0]===ba&&w[2];for(e=j&&l.childNodes[j];e=++j&&e&&e[b]||(r=j=0)||t.pop();)if(1===e.nodeType&&++r&&e===a){p[f]=[ba,j,r];break}}else if(p&&(w=(a[M]||
(a[M]={}))[f])&&w[0]===ba)r=w[1];else for(;e=++j&&e&&e[b]||(r=j=0)||t.pop();)if((n?e.nodeName.toLowerCase()===h:1===e.nodeType)&&++r)if(p&&((e[M]||(e[M]={}))[f]=[ba,r]),e===a)break;r-=c;return r===g||0===r%g&&0<=r/g}}},PSEUDO:function(f,a){var b,g=H.pseudos[f]||H.setFilters[f.toLowerCase()]||E.error("unsupported pseudo: "+f);return g[M]?g(a):1<g.length?(b=[f,f,"",a],H.setFilters.hasOwnProperty(f.toLowerCase())?oa(function(f,b){for(var p,c=g(f,a),k=c.length;k--;)p=Ua.call(f,c[k]),f[p]=!(b[p]=c[k])}):
function(f){return g(f,0,b)}):g}},pseudos:{not:oa(function(f){var a=[],b=[],g=$a(f.replace(wb,"$1"));return g[M]?oa(function(f,a,b,p){p=g(f,null,p,[]);for(var w=f.length;w--;)if(b=p[w])f[w]=!(a[w]=b)}):function(f,c,k){a[0]=f;g(a,null,k,b);return!b.pop()}}),has:oa(function(f){return function(a){return 0<E(f,a).length}}),contains:oa(function(f){return function(a){return-1<(a.textContent||a.innerText||Ka(a)).indexOf(f)}}),lang:oa(function(f){qd.test(f||"")||E.error("unsupported lang: "+f);f=f.replace(Ha,
...
a,b){for(b=0>b?b+a:b;++b<a;)f.push(b);return f})}};H.pseudos.nth=H.pseudos.eq;for(Ba in{radio:!0,checkbox:!0,file:!0,password:!0,image:!0})H.pseudos[Ba]=id(Ba);for(Ba in{submit:!0,reset:!0})H.pseudos[Ba]=jd(Ba);qc.prototype=H.filters=H.pseudos;H.setFilters=new qc;$a=E.compile=function(f,a){var b,g=[],c=[],k=Da[f+" "];if(!k){a||(a=sa(f));for(b=a.length;b--;)k=Wb(a[b]),k[M]?g.push(k):c.push(k);var d=0<g.length,n=0<c.length;b=function(f,a,b,p,w){var k,e,r,j=0,ea="0",t=f&&[],l=[],h=Aa,B=f||n&&H.find.TAG("*",
w),A=ba+=null==h?1:Math.random()||0.1,T=B.length;for(w&&(Aa=a!==R&&a);ea!==T&&null!=(k=B[ea]);ea++){if(n&&k){for(e=0;r=c[e++];)if(r(k,a,b)){p.push(k);break}w&&(ba=A)}d&&((k=!r&&k)&&j--,f&&t.push(k))}j+=ea;if(d&&ea!==j){for(e=0;r=g[e++];)r(t,l,a,b);if(f){if(0<j)for(;ea--;)!t[ea]&&!l[ea]&&(l[ea]=ua.call(p));l=Ta(l)}Ga.apply(p,l);w&&(!f&&0<l.length&&1<j+g.length)&&E.uniqueSort(p)}w&&(ba=A,Aa=h);return t};b=d?oa(b):b;k=Da(f,b)}return k};I.sortStable=M.split("").sort(B).join("")===M;I.detectDuplicates=
...
c){var k=g.map(this,a,b);"Until"!==f.slice(-5)&&(c=b);c&&"string"===typeof c&&(k=g.filter(c,k));1<this.length&&(vd[f]||(k=g.unique(k)),ud.test(f)&&(k=k.reverse()));return this.pushStack(k)}});var xa=/\S+/g,yc={};g.Callbacks=function(f){var a;if("string"===typeof f){if(!(a=yc[f])){a=f;var b=yc[a]={};g.each(a.match(xa)||[],function(f,a){b[a]=!0});a=b}}else a=g.extend({},f);f=a;var c,k,d,n,e,r,j=[],l=!f.once&&[],t=function(a){k=f.memory&&a;d=!0;e=r||0;r=0;n=j.length;for(c=!0;j&&e<n;e++)if(!1===j[e].apply(a[0],
a[1])&&f.stopOnFalse){k=!1;break}c=!1;j&&(l?l.length&&t(l.shift()):k?j=[]:h.disable())},h={add:function(){if(j){var a=j.length;(function $c(a){g.each(a,function(a,b){var p=g.type(b);"function"===p?(!f.unique||!h.has(b))&&j.push(b):b&&(b.length&&"string"!==p)&&$c(b)})})(arguments);c?n=j.length:k&&(r=a,t(k))}return this},remove:function(){j&&g.each(arguments,function(f,a){for(var b;-1<(b=g.inArray(a,j,b));)j.splice(b,1),c&&(b<=n&&n--,b<=e&&e--)});return this},has:function(f){return f?-1<g.inArray(f,
j):!(!j||!j.length)},empty:function(){j=[];n=0;return this},disable:function(){j=l=k=void 0;return this},disabled:function(){return!j},lock:function(){l=void 0;k||h.disable();return this},locked:function(){return!l},fireWith:function(f,a){if(j&&(!d||l))a=a||[],a=[f,a.slice?a.slice():a],c?l.push(a):t(a);return this},fire:function(){h.fireWith(this,arguments);return this},fired:function(){return!!d}};return h};g.extend({Deferred:function(f){var a=[["resolve","done",g.Callbacks("once memory"),"resolved"],
["reject","fail",g.Callbacks("once memory"),"rejected"],["notify","progress",g.Callbacks("memory")]],b="pending",c={state:function(){return b},always:function(){k.done(arguments).fail(arguments);return this},then:function(){var f=arguments;return g.Deferred(function(b){g.each(a,function(a,p){var w=g.isFunction(f[a])&&f[a];k[p[1]](function(){var f=w&&w.apply(this,arguments);if(f&&g.isFunction(f.promise))f.promise().done(b.resolve).fail(b.reject).progress(b.notify);else b[p[0]+"With"](this===c?b.promise():
...
a,b){return function(g){a[f]=this;b[f]=1<arguments.length?n.call(arguments):g;b===r?d.notifyWith(a,b):--k||d.resolveWith(a,b)}},r,j,l;if(1<c){r=Array(c);j=Array(c);for(l=Array(c);a<c;a++)b[a]&&g.isFunction(b[a].promise)?b[a].promise().done(e(a,l,b)).fail(d.reject).progress(e(a,j,r)):--k}k||d.resolveWith(l,b);return d.promise()}});var yb;g.fn.ready=function(f){g.ready.promise().done(f);return this};g.extend({isReady:!1,readyWait:1,holdReady:function(f){f?g.readyWait++:g.ready(!0)},ready:function(f){if(!(!0===
...
e();return k.promise(a)}});var zb=/[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source,Qa=["Top","Right","Bottom","Left"],hb=function(f,a){f=a||f;return"none"===g.css(f,"display")||!g.contains(f.ownerDocument,f)},Va=g.access=function(f,a,b,c,k,d,n){var e=0,r=f.length,j=null==b;if("object"===g.type(b))for(e in k=!0,b)g.access(f,a,e,b[e],!0,d,n);else if(void 0!==c&&(k=!0,g.isFunction(c)||(n=!0),j&&(n?(a.call(f,c),a=null):(j=a,a=function(a,f,b){return j.call(g(a),b)})),a))for(;e<r;e++)a(f[e],b,n?c:c.call(f[e],
e,a(f[e],b)));return k?f:j?a.call(f):r?a(f[0],b):d},Mb=/^(?:checkbox|radio)$/i,Yb=y.createDocumentFragment(),Y=y.createElement("div"),nb=y.createElement("input");Y.setAttribute("className","t");Y.innerHTML="  <link/><table></table><a href='/a'>a</a>";v.leadingWhitespace=3===Y.firstChild.nodeType;v.tbody=!Y.getElementsByTagName("tbody").length;v.htmlSerialize=!!Y.getElementsByTagName("link").length;v.html5Clone="<:nav></:nav>"!==y.createElement("nav").cloneNode(!0).outerHTML;nb.type="checkbox";nb.checked=
...
nb=null,Ab,Bb,Ac=y.createElement("div");for(Ab in{submit:!0,change:!0,focusin:!0})if(Bb="on"+Ab,!(v[Ab+"Bubbles"]=Bb in a))Ac.setAttribute(Bb,"t"),v[Ab+"Bubbles"]=!1===Ac.attributes[Bb].expando;var Zb=/^(?:input|select|textarea)$/i,xd=/^key/,yd=/^(?:mouse|contextmenu)|click/,Bc=/^(?:focusinfocus|focusoutblur)$/,Cc=/^([^.]*)(?:\.(.+)|)$/;g.event={global:{},add:function(a,b,c,k,d){var n,e,r,j,l,t,h,B,A;if(r=g._data(a)){c.handler&&(j=c,c=j.handler,d=j.selector);c.guid||(c.guid=g.guid++);if(!(e=r.events))e=
r.events={};if(!(l=r.handle))l=r.handle=function(a){return typeof g!==ka&&(!a||g.event.triggered!==a.type)?g.event.dispatch.apply(l.elem,arguments):void 0},l.elem=a;b=(b||"").match(xa)||[""];for(r=b.length;r--;)if(n=Cc.exec(b[r])||[],B=t=n[1],A=(n[2]||"").split(".").sort(),B){n=g.event.special[B]||{};B=(d?n.delegateType:n.bindType)||B;n=g.event.special[B]||{};t=g.extend({type:B,origType:t,data:k,handler:c,guid:c.guid,selector:d,needsContext:d&&g.expr.match.needsContext.test(d),namespace:A.join(".")},
j);if(!(h=e[B]))if(h=e[B]=[],h.delegateCount=0,!n.setup||!1===n.setup.call(a,k,A,l))a.addEventListener?a.addEventListener(B,l,!1):a.attachEvent&&a.attachEvent("on"+B,l);n.add&&(n.add.call(a,t),t.handler.guid||(t.handler.guid=c.guid));d?h.splice(h.delegateCount++,0,t):h.push(t);g.event.global[B]=!0}a=null}},remove:function(a,b,c,k,d){var n,e,r,j,l,t,h,B,A,T,q,m=g.hasData(a)&&g._data(a);if(m&&(t=m.events)){b=(b||"").match(xa)||[""];for(l=b.length;l--;)if(r=Cc.exec(b[l])||[],A=q=r[1],T=(r[2]||"").split(".").sort(),
A){h=g.event.special[A]||{};A=(k?h.delegateType:h.bindType)||A;B=t[A]||[];r=r[2]&&RegExp("(^|\\.)"+T.join("\\.(?:.*\\.|)")+"(\\.|$)");for(j=n=B.length;n--;)if(e=B[n],(d||q===e.origType)&&(!c||c.guid===e.guid)&&(!r||r.test(e.namespace))&&(!k||k===e.selector||"**"===k&&e.selector))B.splice(n,1),e.selector&&B.delegateCount--,h.remove&&h.remove.call(a,e);j&&!B.length&&((!h.teardown||!1===h.teardown.call(a,T,m.handle))&&g.removeEvent(a,A,m.handle),delete t[A])}else for(A in t)g.event.remove(a,A+b[l],c,
k,!0);g.isEmptyObject(t)&&(delete m.handle,g._removeData(a,"events"))}},trigger:function(f,b,c,k){var d,n,e,r,j,l,t=[c||y],h=za.call(f,"type")?f.type:f;j=za.call(f,"namespace")?f.namespace.split("."):[];e=d=c=c||y;if(!(3===c.nodeType||8===c.nodeType)&&!Bc.test(h+g.event.triggered))if(0<=h.indexOf(".")&&(j=h.split("."),h=j.shift(),j.sort()),n=0>h.indexOf(":")&&"on"+h,f=f[g.expando]?f:new g.Event(h,"object"===typeof f&&f),f.isTrigger=k?2:3,f.namespace=j.join("."),f.namespace_re=f.namespace?RegExp("(^|\\.)"+
j.join("\\.(?:.*\\.|)")+"(\\.|$)"):null,f.result=void 0,f.target||(f.target=c),b=null==b?[f]:g.makeArray(b,[f]),j=g.event.special[h]||{},k||!(j.trigger&&!1===j.trigger.apply(c,b))){if(!k&&!j.noBubble&&!g.isWindow(c)){r=j.delegateType||h;Bc.test(r+h)||(e=e.parentNode);for(;e;e=e.parentNode)t.push(e),d=e;if(d===(c.ownerDocument||y))t.push(d.defaultView||d.parentWindow||a)}for(l=0;(e=t[l++])&&!f.isPropagationStopped();)if(f.type=1<l?r:j.bindType||h,(d=(g._data(e,"events")||{})[f.type]&&g._data(e,"handle"))&&
d.apply(e,b),(d=n&&e[n])&&d.apply&&g.acceptData(e))f.result=d.apply(e,b),!1===f.result&&f.preventDefault();f.type=h;if(!k&&!f.isDefaultPrevented()&&(!j._default||!1===j._default.apply(t.pop(),b))&&g.acceptData(c)&&n&&c[h]&&!g.isWindow(c)){(d=c[n])&&(c[n]=null);g.event.triggered=h;try{c[h]()}catch(B){}g.event.triggered=void 0;d&&(c[n]=d)}return f.result}},dispatch:function(a){a=g.event.fix(a);var b,c,k,d,e=[],r=n.call(arguments);b=(g._data(this,"events")||{})[a.type]||[];var j=g.event.special[a.type]||
...
g&&g.clientLeft||0),a.pageY=b.clientY+(c&&c.scrollTop||g&&g.scrollTop||0)-(c&&c.clientTop||g&&g.clientTop||0));!a.relatedTarget&&d&&(a.relatedTarget=d===a.target?b.toElement:d);!a.which&&void 0!==k&&(a.which=k&1?1:k&2?3:k&4?2:0);return a}},special:{load:{noBubble:!0},focus:{trigger:function(){if(this!==F()&&this.focus)try{return this.focus(),!1}catch(a){}},delegateType:"focusin"},blur:{trigger:function(){if(this===F()&&this.blur)return this.blur(),!1},delegateType:"focusout"},click:{trigger:function(){if(g.nodeName(this,
...
if(this!==b||a.isSimulated||a.isTrigger||"radio"!==b.type&&"checkbox"!==b.type)return a.handleObj.handler.apply(this,arguments)},teardown:function(){g.event.remove(this,"._change");return!Zb.test(this.nodeName)}});v.focusinBubbles||g.each({focus:"focusin",blur:"focusout"},function(a,b){var c=function(a){g.event.simulate(b,a.target,g.event.fix(a),!0)};g.event.special[b]={setup:function(){var k=this.ownerDocument||this,d=g._data(k,b);d||k.addEventListener(a,c,!0);g._data(k,b,(d||0)+1)},teardown:function(){var k=
this.ownerDocument||this,d=g._data(k,b)-1;d?g._data(k,b,d):(k.removeEventListener(a,c,!0),g._removeData(k,b))}}});g.fn.extend({on:function(a,b,c,k,d){var n,e;if("object"===typeof a){"string"!==typeof b&&(c=c||b,b=void 0);for(n in a)this.on(n,b,c,a[n],d);return this}null==c&&null==k?(k=b,c=b=void 0):null==k&&("string"===typeof b?(k=c,c=void 0):(k=c,c=b,b=void 0));if(!1===k)k=t;else if(!k)return this;1===d&&(e=k,k=function(a){g().off(a);return e.apply(this,arguments)},k.guid=e.guid||(e.guid=g.guid++));
return this.each(function(){g.event.add(this,a,k,c,b)})},one:function(a,b,g,c){return this.on(a,b,g,c,1)},off:function(a,b,c){var k;if(a&&a.preventDefault&&a.handleObj)return k=a.handleObj,g(a.delegateTarget).off(k.namespace?k.origType+"."+k.namespace:k.origType,k.selector,k.handler),this;if("object"===typeof a){for(k in a)this.off(k,b,a[k]);return this}if(!1===b||"function"===typeof b)c=b,b=void 0;!1===c&&(c=t);return this.each(function(){g.event.remove(this,a,c,b)})},trigger:function(a,b){return this.each(function(){g.event.trigger(a,
...
C(y).appendChild(y.createElement("div"));ja.optgroup=ja.option;ja.tbody=ja.tfoot=ja.colgroup=ja.caption=ja.thead;ja.th=ja.td;g.extend({clone:function(a,b,c){var k,d,n,e,r,j=g.contains(a.ownerDocument,a);v.html5Clone||g.isXMLDoc(a)||!Dc.test("<"+a.nodeName+">")?n=a.cloneNode(!0):(ac.innerHTML=a.outerHTML,ac.removeChild(n=ac.firstChild));if((!v.noCloneEvent||!v.noCloneChecked)&&(1===a.nodeType||11===a.nodeType)&&!g.isXMLDoc(a)){k=K(n);r=K(a);for(e=0;null!=(d=r[e]);++e)if(k[e]){var l=k[e],h=void 0,t=
...
h)l.defaultSelected=l.selected=d.defaultSelected;else if("input"===h||"textarea"===h)l.defaultValue=d.defaultValue}}}if(b)if(c){r=r||K(a);k=k||K(n);for(e=0;null!=(d=r[e]);e++)Fa(d,k[e])}else Fa(a,n);k=K(n,"script");0<k.length&&Q(k,!j&&K(a,"script"));return n},buildFragment:function(a,b,c,k){for(var d,n,e,r,j,l,h=a.length,t=C(b),B=[],A=0;A<h;A++)if((n=a[A])||0===n)if("object"===g.type(n))g.merge(B,n.nodeType?[n]:n);else if(Ad.test(n)){e=e||t.appendChild(b.createElement("div"));r=(Fc.exec(n)||["",""])[1].toLowerCase();
l=ja[r]||ja._default;e.innerHTML=l[1]+n.replace(Ec,"<$1></$2>")+l[2];for(d=l[0];d--;)e=e.lastChild;!v.leadingWhitespace&&$b.test(n)&&B.push(b.createTextNode($b.exec(n)[0]));if(!v.tbody)for(d=(n="table"===r&&!Gc.test(n)?e.firstChild:"<table>"===l[1]&&!Gc.test(n)?e:0)&&n.childNodes.length;d--;)g.nodeName(j=n.childNodes[d],"tbody")&&!j.childNodes.length&&n.removeChild(j);g.merge(B,e.childNodes);for(e.textContent="";e.firstChild;)e.removeChild(e.firstChild);e=t.lastChild}else B.push(b.createTextNode(n));
e&&t.removeChild(e);v.appendChecked||g.grep(K(B,"input"),rb);for(A=0;n=B[A++];)if(!(k&&-1!==g.inArray(n,k))&&(a=g.contains(n.ownerDocument,n),e=K(t.appendChild(n),"script"),a&&Q(e),c))for(d=0;n=e[d++];)Hc.test(n.type||"")&&c.push(n);return t},cleanData:function(a,b){for(var c,d,n,e,r=0,j=g.expando,l=g.cache,h=v.deleteExpando,t=g.event.special;null!=(c=a[r]);r++)if(b||g.acceptData(c))if(e=(n=c[j])&&l[n]){if(e.events)for(d in e.events)t[d]?g.event.remove(c,d):g.removeEvent(c,d,e.handle);l[n]&&(delete l[n],
h?delete c[j]:typeof c.removeAttribute!==ka?c.removeAttribute(j):c[j]=null,k.push(n))}}});g.fn.extend({text:function(a){return Va(this,function(a){return void 0===a?g.text(this):this.empty().append((this[0]&&this[0].ownerDocument||y).createTextNode(a))},null,a,arguments.length)},append:function(){return this.domManip(arguments,function(a){(1===this.nodeType||11===this.nodeType||9===this.nodeType)&&Ya(this,a).appendChild(a)})},prepend:function(){return this.domManip(arguments,function(a){if(1===this.nodeType||
...
a.elem.parentNode&&(a.elem[a.prop]=a.now)}};g.easing={linear:function(a){return a},swing:function(a){return 0.5-Math.cos(a*Math.PI)/2}};g.fx=L.prototype.init;g.fx.step={};var Za,Hb,Jd=/^(?:toggle|show|hide)$/,Kc=RegExp("^(?:([+-])=|)("+zb+")([a-z%]*)$","i"),Kd=/queueHooks$/,tb=[function(a,b,c){var k,d,n,e,r,j,l=this,h={},t=a.style,B=a.nodeType&&hb(a),A=g._data(a,"fxshow");c.queue||(e=g._queueHooks(a,"fx"),null==e.unqueued&&(e.unqueued=0,r=e.empty.fire,e.empty.fire=function(){e.unqueued||r()}),e.unqueued++,
l.always(function(){l.always(function(){e.unqueued--;g.queue(a,"fx").length||e.empty.fire()})}));if(1===a.nodeType&&("height"in b||"width"in b))c.overflow=[t.overflow,t.overflowX,t.overflowY],d=g.css(a,"display"),j=db(a.nodeName),"none"===d&&(d=j),"inline"===d&&"none"===g.css(a,"float")&&(!v.inlineBlockNeedsLayout||"inline"===j?t.display="inline-block":t.zoom=1);c.overflow&&(t.overflow="hidden",v.shrinkWrapBlocks()||l.always(function(){t.overflow=c.overflow[0];t.overflowX=c.overflow[1];t.overflowY=
c.overflow[2]}));for(k in b)if(d=b[k],Jd.exec(d)){delete b[k];n=n||"toggle"===d;if(d===(B?"hide":"show"))if("show"===d&&A&&void 0!==A[k])B=!0;else continue;h[k]=A&&A[k]||g.style(a,k)}if(!g.isEmptyObject(h))for(k in A?"hidden"in A&&(B=A.hidden):A=g._data(a,"fxshow",{}),n&&(A.hidden=!B),B?g(a).show():l.done(function(){g(a).hide()}),l.done(function(){var b;g._removeData(a,"fxshow");for(b in h)g.style(a,b,h[b])}),h)b=wa(B?A[k]:0,k,l),k in A||(A[k]=b.start,B&&(b.end=b.start,b.start="width"===k||"height"===
...
this.each(function(){if("string"===c)for(var b,k=0,d=g(this),n=a.match(xa)||[];b=n[k++];)d.hasClass(b)?d.removeClass(b):d.addClass(b);else if(c===ka||"boolean"===c)this.className&&g._data(this,"__className__",this.className),this.className=this.className||!1===a?"":g._data(this,"__className__")||""})},hasClass:function(a){a=" "+a+" ";for(var b=0,c=this.length;b<c;b++)if(1===this[b].nodeType&&0<=(" "+this[b].className+" ").replace(ic," ").indexOf(a))return!0;return!1}});g.each("blur focus focusin focusout load resize scroll unload click dblclick mousedown mouseup mousemove mouseover mouseout mouseenter mouseleave change select submit keydown keypress keyup error contextmenu".split(" "),
...
g.ajaxSettings),b):ya(g.ajaxSettings,a)},ajaxPrefilter:kb(Oc),ajaxTransport:kb(Nb),ajax:function(a,b){function c(a,b,f,k){var d,t,p,F;F=b;if(2!==da){da=2;r&&clearTimeout(r);l=void 0;e=k||"";s.readyState=0<a?4:0;k=200<=a&&300>a||304===a;if(f){p=h;for(var w=s,N,ha,G,C,z=p.contents,P=p.dataTypes;"*"===P[0];)P.shift(),void 0===ha&&(ha=p.mimeType||w.getResponseHeader("Content-Type"));if(ha)for(C in z)if(z[C]&&z[C].test(ha)){P.unshift(C);break}if(P[0]in f)G=P[0];else{for(C in f){if(!P[0]||p.converters[C+
" "+P[0]]){G=C;break}N||(N=C)}G=G||N}G?(G!==P[0]&&P.unshift(G),p=f[G]):p=void 0}a:{f=h;N=p;ha=s;G=k;var K,v,ua,w={},z=f.dataTypes.slice();if(z[1])for(v in f.converters)w[v.toLowerCase()]=f.converters[v];for(C=z.shift();C;)if(f.responseFields[C]&&(ha[f.responseFields[C]]=N),!ua&&(G&&f.dataFilter)&&(N=f.dataFilter(N,f.dataType)),ua=C,C=z.shift())if("*"===C)C=ua;else if("*"!==ua&&ua!==C){v=w[ua+" "+C]||w["* "+C];if(!v)for(K in w)if(p=K.split(" "),p[1]===C&&(v=w[ua+" "+p[0]]||w["* "+p[0]])){!0===v?v=
w[K]:!0!==w[K]&&(C=p[0],z.unshift(p[1]));break}if(!0!==v)if(v&&f["throws"])N=v(N);else try{N=v(N)}catch(u){p={state:"parsererror",error:v?u:"No conversion from "+ua+" to "+C};break a}}p={state:"success",data:N}}if(k)h.ifModified&&((F=s.getResponseHeader("Last-Modified"))&&(g.lastModified[n]=F),(F=s.getResponseHeader("etag"))&&(g.etag[n]=F)),204===a||"HEAD"===h.type?F="nocontent":304===a?F="notmodified":(F=p.state,d=p.data,t=p.error,k=!t);else if(t=F,a||!F)F="error",0>a&&(a=0);s.status=a;s.statusText=
(b||F)+"";k?T.resolveWith(B,[d,F,s]):T.rejectWith(B,[s,F,t]);s.statusCode(m);m=void 0;j&&A.trigger(k?"ajaxSuccess":"ajaxError",[s,h,k?d:t]);q.fireWith(B,[s,F]);j&&(A.trigger("ajaxComplete",[s,h]),--g.active||g.event.trigger("ajaxStop"))}}"object"===typeof a&&(b=a,a=void 0);b=b||{};var k,d,n,e,r,j,l,t,h=g.ajaxSetup({},b),B=h.context||h,A=h.context&&(B.nodeType||B.jquery)?g(B):g.event,T=g.Deferred(),q=g.Callbacks("once memory"),m=h.statusCode||{},F={},N={},da=0,ha="canceled",s={readyState:0,getResponseHeader:function(a){var b;
...
q.add;s.success=s.done;s.error=s.fail;h.url=((a||h.url||Oa)+"").replace(Pd,"").replace(Sd,Xa[1]+"//");h.type=b.method||b.type||h.method||h.type;h.dataTypes=g.trim(h.dataType||"*").toLowerCase().match(xa)||[""];null==h.crossDomain&&(k=Nc.exec(h.url.toLowerCase()),h.crossDomain=!(!k||!(k[1]!==Xa[1]||k[2]!==Xa[2]||(k[3]||("http:"===k[1]?"80":"443"))!==(Xa[3]||("http:"===Xa[1]?"80":"443")))));h.data&&(h.processData&&"string"!==typeof h.data)&&(h.data=g.param(h.data,h.traditional));ub(Oc,h,b,s);if(2===
da)return s;(j=h.global)&&0===g.active++&&g.event.trigger("ajaxStart");h.type=h.type.toUpperCase();h.hasContent=!Rd.test(h.type);n=h.url;h.hasContent||(h.data&&(n=h.url+=(kc.test(n)?"&":"?")+h.data,delete h.data),!1===h.cache&&(h.url=Mc.test(n)?n.replace(Mc,"$1_="+jc++):n+(kc.test(n)?"&":"?")+"_="+jc++));h.ifModified&&(g.lastModified[n]&&s.setRequestHeader("If-Modified-Since",g.lastModified[n]),g.etag[n]&&s.setRequestHeader("If-None-Match",g.etag[n]));(h.data&&h.hasContent&&!1!==h.contentType||b.contentType)&&
s.setRequestHeader("Content-Type",h.contentType);s.setRequestHeader("Accept",h.dataTypes[0]&&h.accepts[h.dataTypes[0]]?h.accepts[h.dataTypes[0]]+("*"!==h.dataTypes[0]?", "+Pc+"; q=0.01":""):h.accepts["*"]);for(d in h.headers)s.setRequestHeader(d,h.headers[d]);if(h.beforeSend&&(!1===h.beforeSend.call(B,s,h)||2===da))return s.abort();ha="abort";for(d in{success:1,error:1,complete:1})s[d](h[d]);if(l=ub(Nb,h,b,s)){s.readyState=1;j&&A.trigger("ajaxSend",[s,h]);h.async&&0<h.timeout&&(r=setTimeout(function(){s.abort("timeout")},
h.timeout));try{da=1,l.send(F,c)}catch(G){if(2>da)c(-1,G);else throw G;}}else c(-1,"No Transport");return s},getJSON:function(a,b,c){return g.get(a,b,c,"json")},getScript:function(a,b){return g.get(a,void 0,b,"script")}});g.each(["get","post"],function(a,b){g[b]=function(a,c,f,k){g.isFunction(c)&&(k=k||f,f=c,c=void 0);return g.ajax({url:a,type:b,dataType:k,data:c,success:f})}});g.each("ajaxStart ajaxStop ajaxComplete ajaxError ajaxSuccess ajaxSend".split(" "),function(a,b){g.fn[b]=function(a){return this.on(b,
...
b.left-n.left+k);"using"in b?b.using.call(a,h):r.css(h)}};g.fn.extend({offset:function(a){if(arguments.length)return void 0===a?this:this.each(function(b){g.offset.setOffset(this,a,b)});var b,c,k={top:0,left:0},d=(c=this[0])&&c.ownerDocument;if(d){b=d.documentElement;if(!g.contains(b,c))return k;typeof c.getBoundingClientRect!==ka&&(k=c.getBoundingClientRect());c=V(d);return{top:k.top+(c.pageYOffset||b.scrollTop)-(b.clientTop||0),left:k.left+(c.pageXOffset||b.scrollLeft)-(b.clientLeft||0)}}},position:function(){if(this[0]){var a,
...
(function(a,m,j,h){function e(e,j){function s(b){a(u).each(function(){self.Jmol&&(0<=j.indexOf("mouseup")||0<=j.indexOf("touchend"))&&Jmol._setMouseOwner(null);var d=a(this);this!==b.target&&!d.has(b.target).length&&d.triggerHandler(j,[b.target,b])})}j=j||e+h;var u=a(),b=e+"."+j+"-special-event";a.event.special[j]={setup:function(){u=u.add(this);1===u.length&&a(m).bind(b,s)},teardown:function(){self.Jmol&&Jmol._setMouseOwner(null);u=u.not(this);0===u.length&&a(m).unbind(b)},add:function(a){var b=
a.handler;a.handler=function(a,c){a.target=c;b.apply(this,arguments)}}}}a.map(j.split(" "),function(a){e(a)});e("focusin","focus"+h);e("focusout","blur"+h)})(jQuery,document,"click mousemove mouseup touchmove touchend","outjsmol");"undefined"==typeof jQuery&&alert("Note -- JSmoljQuery is required for JSmol, but it's not defined.");self.Jmol||(Jmol={});
...
c,d)})};a._extractInfoFromRCSB=function(b,c,d,e){var h=e.length/5;if(0!=h&&4==d.length&&1!=h){d=d.toUpperCase();var j=e.indexOf(d);0<j&&0<="123456789".indexOf(d.substring(0,1))&&(e=d+","+e.substring(0,j)+e.substring(j+5));50<h&&(e=e.substring(0,250));e=e.replace(/\n/g,",");e=a._restReportUrl.replace(/IDLIST/,e);a._loadFileData(b,e,function(d){a._setInfo(b,c,d)})}};a._checkAjaxPost=function(a){var c=a.url.indexOf("?POST?");0<c&&(a.data=a.url.substring(c+6),a.url=a.url.substring(0,c),a.type="POST",
a.contentType="application/x-www-form-urlencoded")};a._contactServer=function(b,c,d){b={dataType:"text",type:"GET",url:a._serverUrl+b,success:function(b){a._loadSuccess(b,c)},error:function(){a._loadError(d)},async:c?a._asynchronous:!1};a._checkAjaxPost(b);return a._ajax(b)};a._setQueryTerm=function(b,c){if(c&&b._hasOptions&&"http://"!=c.substring(0,7)){if(a._isDatabaseCall(c)){var d=c.substring(0,1);c=c.substring(1);c.substring(0,1)==d&&0<="=$".indexOf(d)&&(c=c.substring(1));var e=a._getElement(b,
"select");if(e&&e.options)for(var h=0;h<e.options.length;h++)e[h].value==d&&(e[h].selected=!0)}a.$val(a.$(b,"query"),c)}};a._search=function(b,c,d){1<arguments.length||(c=null);a._setQueryTerm(b,c);c||(c=a.$val(a.$(b,"query")));0==c.indexOf("!")?b._script(c.substring(1)):(c&&(c=c.replace(/\"/g,"")),b._showInfo(!1),a._searchMol(b,c,d,!0))};a._searchMol=function(b,c,d,e){var h;a._isDatabaseCall(c)?(h=c.substring(0,1),c=c.substring(1)):h=b._hasOptions?a.$val(a.$(b,"select")):"$";"="==h&&3==c.length&&
(c="="+c);var j=h+c;if(c&&!(0>j.indexOf("?")&&j==b._thisJmolModel)){b._thisJmolModel=j;var l;e&&null!=b._viewSet&&null!=(l=a.View.__findView(b._viewSet,{chemID:j}))?a.View.__setView(l,b,!1):("$"==h||":"==h?b._jmolFileType="MOL":"="==h&&(b._jmolFileType="PDB"),b._searchDatabase(c,h,d))}};a._searchDatabase=function(b,c,d,e){b._showInfo(!1);return 0<=c.indexOf("?")?(a._getInfoFromDatabase(b,d,c.split("?")[0]),!0):a.db._DirectDatabaseCalls[d]?(b._loadFile(d+c,e),!0):!1};a._syncBinaryOK="?";a._canSyncBinary=
function(b){if(a._isAsync)return!0;if(self.VBArray)return a._syncBinaryOK=!1;if("?"!=a._syncBinaryOK)return a._syncBinaryOK;a._syncBinaryOK=!0;try{var c=new window.XMLHttpRequest;c.open("text",a._ajaxTestSite,!1);c.hasOwnProperty("responseType")?c.responseType="arraybuffer":c.overrideMimeType&&c.overrideMimeType("text/plain; charset=x-user-defined")}catch(d){return System.out.println("JSmolCore.js: synchronous binary file transfer is requested but not available"),a._alertNoBinary&&!b&&alert("JSmolCore.js: synchronous binary file transfer is requested but not available"),
a._syncBinaryOK=!1}return!0};a._binaryTypes="mmtf .gz .jpg .gif .png .zip .jmol .bin .smol .spartan .mrc .map .ccp4 .dn6 .delphi .omap .pse .dcd".split(" ");a._isBinaryUrl=function(b){for(var c=a._binaryTypes.length;0<=--c;)if(0<=b.indexOf(a._binaryTypes[c]))return!0;return!1};a._getFileData=function(b,c,d){var e=a._isBinaryUrl(b),h=0<=b.indexOf(".gz")&&0<=b.indexOf("rcsb.org");h&&(b=b.replace(/\.gz/,""),e=!1);var h=e&&!c&&!a._canSyncBinary(h),j=0<=b.indexOf("?POST?");0==b.indexOf("file:/")&&0!=b.indexOf("file:///")&&
(b="file://"+b.substring(5));var l=0>b.indexOf("://")||0==b.indexOf(document.location.protocol)&&0<=b.indexOf(document.location.host),q="https://"==a._httpProto&&0==b.indexOf("http://"),m=a._isDirectCall(b);!m&&0<=b.indexOf("?ALLOWSORIGIN?")&&(m=!0,b=b.replace(/\?ALLOWSORIGIN\?/,""));var s=!l&&a.$supportsIECrossDomainScripting(),u=null;if(q||h||!l&&!m||!c&&s)u=a._getRawDataFromServer("_",b,c,c,h,!0);else{b=b.replace(/file:\/\/\/\//,"file://");var Q={dataType:e?"binary":"text",async:!!c};j?(Q.type=
"POST",Q.url=b.split("?POST?")[0],Q.data=b.split("?POST?")[1]):(Q.type="GET",Q.url=b);c&&(Q.success=function(){c(a._xhrReturn(Q.xhr))},Q.error=function(){c(Q.xhr.statusText)});Q.xhr=a.$ajax(Q);c||(u=a._xhrReturn(Q.xhr))}if(!d)return u;null==u&&(u="",e=!1);e&&(e=a._canSyncBinary(!0));return e?a._strToBytes(u):JU.SB.newS(u)};a._xhrReturn=function(a){return!a.responseText||self.Clazz&&Clazz.instanceOf(a.response,self.ArrayBuffer)?a.response||a.statusText:a.responseText};a._isDirectCall=function(b){if(0<=
b.indexOf("?ALLOWSORIGIN?"))return!0;for(var c in a.db._DirectDatabaseCalls)if(0<=c.indexOf(".")&&0<=b.indexOf(c))return!0;return!1};a._cleanFileData=function(a){return 0<=a.indexOf("\r")&&0<=a.indexOf("\n")?a.replace(/\r\n/g,"\n"):0<=a.indexOf("\r")?a.replace(/\r/g,"\n"):a};a._getFileType=function(a){var c=a.substring(0,1);if("$"==c||":"==c)return"MOL";if("="==c)return"="==a.substring(1,2)?"LCIF":"PDB";a=a.split(".").pop().toUpperCase();return a.substring(0,Math.min(a.length,3))};a._getZ=function(b,
c){return b&&b._z&&b._z[c]||a._z[c]};a._incrZ=function(b,c){return b&&b._z&&++b._z[c]||++a._z[c]};a._hideLocalFileReader=function(b){b._localReader&&a.$setVisible(b._localReader,!1);b._readingLocal=!1;a._setCursor(b,0)};a.loadFileFromDialog=function(b){a._loadFileAsynchronously(null,b,null,null)};a._loadFileAsynchronously=function(b,c,d,e){if(d&&0!=d.indexOf("?")){var h=d;d=a._checkFileName(c,d);var j=function(j){a._setData(b,d,h,j,e,c)},j=a._checkCache(c,d,j);0<=d.indexOf("|")&&(d=d.split("|")[0]);
return null==j?null:a._getFileData(d,j)}if(!a.featureDetection.hasFileReader)return b?b.setData(msg,null,null,e,c):alert(msg);c._localReader||(j='<div id="ID" style="z-index:'+a._getZ(c,"fileOpener")+';position:absolute;background:#E0E0E0;left:10px;top:10px"><div style="margin:5px 5px 5px 5px;"><button id="ID_loadurl">URL</button><input type="file" id="ID_files" /><button id="ID_loadfile">load</button><button id="ID_cancel">cancel</button></div><div>',a.$after("#"+c._id+"_appletdiv",j.replace(/ID/g,
c._id+"_localReader")),c._localReader=a.$(c,"localReader"));a.$appEvent(c,"localReader_loadurl","click");a.$appEvent(c,"localReader_loadurl","click",function(){var b=prompt("Enter a URL");b&&(a._hideLocalFileReader(c,0),a._setData(null,b,b,null,e,c))});a.$appEvent(c,"localReader_loadfile","click");a.$appEvent(c,"localReader_loadfile","click",function(){var d=a.$(c,"localReader_files")[0].files[0],h=new FileReader;h.onloadend=function(h){h.target.readyState==FileReader.DONE&&(a._hideLocalFileReader(c,
0),a._setData(b,d.name,d.name,h.target.result,e,c))};try{h.readAsArrayBuffer(d)}catch(j){alert("You must select a file first.")}});a.$appEvent(c,"localReader_cancel","click");a.$appEvent(c,"localReader_cancel","click",function(){a._hideLocalFileReader(c);b&&b.setData("#CANCELED#",null,null,e,c)});a.$setVisible(c._localReader,!0);c._readingLocal=!0};a._setData=function(b,c,d,e,h,j){e&&(e=a._strToBytes(e));null!=e&&(null==b||0<=c.indexOf(".jdx"))&&a.Cache.put("cache://"+c,e);null==b?j._applet.openFileAsyncSpecial(null==
e?c:"cache://"+c,1):b.setData(c,d,e,h)};a._doAjax=function(b,c,d){b=b.toString();if(null!=d)return a._saveFile(b,d);c&&(b+="?POST?"+c);return a._getFileData(b,null,!0)};a._saveFile=function(b,c,d,e){if(a._localFileSaveFunction&&a._localFileSaveFunction(b,c))return"OK";b=b.substring(b.lastIndexOf("/")+1);d||(d=0<=b.indexOf(".pdf")?"application/pdf":0<=b.indexOf(".png")?"image/png":0<=b.indexOf(".gif")?"image/gif":0<=b.indexOf(".jpg")?"image/jpg":"");var h="string"==typeof c;h||(c=(JU?JU:J.util).Base64.getBase64(c).toString());
...
a._getZ(b,"coverImage")+';" />';d=a._appletCssText.replace(/\'/g,'"');var j=b._getSpinner&&b._getSpinner();b._spinner=j=!j||"none"==j?"":"background-image:url("+j+"); background-repeat:no-repeat; background-position:center;";d=j+(0<=d.indexOf('style="')?d.split('style="')[1]:'" '+d);d='...<div id="ID_appletinfotablediv" style="width:Wpx;height:Hpx;position:relative;font-size:14px;text-align:left">IMG WAIT......<div id="ID_appletdiv" style="z-index:'+a._getZ(b,"header")+";width:100%;height:100%;position:absolute;top:0px;left:0px;"+
d+">";var j=b._height,l=b._width;if("string"!==typeof j||0>j.indexOf("%"))j+="px";if("string"!==typeof l||0>l.indexOf("%"))l+="px";d=d.replace(/IMG/,e).replace(/WAIT/,h).replace(/Hpx/g,j).replace(/Wpx/g,l)}else d='......</div>......<div id="ID_2dappletdiv" style="position:absolute;width:100%;height:100%;overflow:hidden;display:none"></div>......<div id="ID_infotablediv" style="width:100%;height:100%;position:absolute;top:0px;left:0px">.........<div id="ID_infoheaderdiv" style="height:20px;width:100%;background:yellow;display:none"><span id="ID_infoheaderspan"></span><span id="ID_infocheckboxspan" style="position:absolute;text-align:right;right:1px;"><a href="javascript:Jmol.showInfo(ID,false)">[x]</a></span></div>.........<div id="ID_infodiv" style="position:absolute;top:20px;bottom:0px;width:100%;height:100%;overflow:auto"></div>......</div>...</div>';
...
return!d?null:c&&void 0!=d[c]?d[c]:d};a._sortMessages=function(a){function c(a,b){return a[0]<b[0]?1:a[0]>b[0]?-1:0}if(!a||"object"!=typeof a)return[];for(var d=[],e=a.length-1;0<=e;e--)for(var h=0,j=a[e].length;h<j;h++)d[d.length]=a[e][h];if(0!=d.length)return d=d.sort(c)};a._setMouseOwner=function(b,c){null==b||c?a._mouseOwner=b:a._mouseOwner==b&&(a._mouseOwner=null)};a._jsGetMouseModifiers=function(a){var c=0;switch(a.button){case 0:c=16;break;case 1:c=8;break;case 2:c=4}a.shiftKey&&(c+=1);a.altKey&&
...
for(var h in a)e+="\napplet "+a[h]._id+" currentView="+(a[h]._currentView?a[h]._currentView.info.viewID:null);for(h=d.length;0<=--h;){a=d[h];var e=e+("\n\n<b>view="+h+" viewID="+a.info.viewID+" chemID="+a.info.chemID+"</b>\n"),j,l;for(l in a)"info"!=l&&(e+="\nview="+h+" type="+l+" applet="+((j=a[l]).applet?j.applet._id:null)+" SMILES="+j.smiles+"\n atomMap="+JSON.stringify(j.atomMap)+"\n data=\n"+j.data+"\n")}return e}};b.__init=function(a){var d=a._viewSet,e=b.applets;e[d]||(e[d]={});e[d][a._viewType]=
a};b.__findView=function(a,d){var e=b.sets[a];null==e&&(e=b.sets[a]=[]);for(var h=e.length;0<=--h;){var j=e[h];if(d.viewID){if(j.info.viewID==d.viewID)return j}else{if(null!=d.chemID&&d.chemID==j.info.chemID)return j;for(var l in j)if("info"!=l&&(null!=d.data&&null!=j[l].data?d.data==j[l].data:d.type==l))return j}}return null};b.__createViewSet=function(c,d,e){b.count++;d={info:{chemID:d,viewID:e||"model_"+b.count}};for(var h in a._applets)e=a._applets[h],e._viewSet==c&&(d[e._viewType]={applet:e,
data:null});b.sets[c].push(d);return d};b.__setView=function(a,b,e){for(var h in a)if("info"!=h){var j=a[h],l=j.applet,q=e||null!=l&&"<modified>"==l._molData;if(!(null==l||l==b&&!q)){var m=null==j.data,s=null!=l._currentView;l._currentView=a;if(!s||!(a[h].data==j.data&&!m&!q))if(l._loadModelFromView(a),m)break}}}})(a.View);a.Cache={fileCache:{}};a.Cache.get=function(b){return a.Cache.fileCache[b]};a.Cache.put=function(b,c){a.Cache.fileCache[b]=c};a.Cache.setDragDrop=function(b){a.$appEvent(b,"appletdiv",
...
(function(a){a._isAsync=!1;a._asyncCallbacks={};a._coreFiles=[];var m=!1,j=[],h=[],e=0,l=[],q=[],s=function(b){arguments.length||(b=!0);delete e;for(var d;0<h.length&&"done"==(d=h[0])[4];)h.shift();if(0!=h.length)if(!a._isAsync&&!b)setTimeout(s,10);else{d.push("done");var l="JSmol exec "+d[0]._id+" "+d[3]+" "+d[2];self.System&&System.out.println(l);self.console&&console.log(l+" -- OK");j.push(l);d[1](d[0],d[2])}},u=function(b){m?s():(m=!0,LoadClazz(),b._noMonitor&&(Clazz._LoaderProgressMonitor.showStatus=
function(){}),LoadClazz=null,b.__Info.uncompressed&&Clazz.loadClass(),Clazz._Loader.onGlobalLoaded=function(){Clazz._LoaderProgressMonitor.showStatus("Application loaded.",!0);if(!a._debugCode||!a.haveCore)a.haveCore=!0,s()},Clazz._Loader.loadPackageClasspath("java",null,!0,s))},b=function(a,b){Clazz._Loader.loadClass(b,function(){s()})};a.showExecLog=function(){return j.join("\n")};a._addExec=function(a){a[1]||(a[1]=b);var d="JSmol load "+a[0]._id+" "+a[3];self.console&&console.log(d+"...");j.push(d);
...
d._isLayered||!1;this._isSwing=d._isSwing||!1;this._isJSV=d._isJSV||!1;this._isAstex=d._isAstex||!1;this._platform=d._platform||"";if(h)return this;window[b]=this;this._createCanvas(b,d);if(!a._document||this._deferApplet)return this;this._init();return this};a._setAppletParams=function(b,d,e,h){for(var j in e)if(!b||0<=b.indexOf(";"+j.toLowerCase()+";"))null==e[j]||"language"==j&&!a.featureDetection.supportsLocalization()||(h?d.put(j,!0===e[j]?Boolean.TRUE:!1===e[j]?Boolean.FALSE:e[j]):d[j]=e[j])};
...
try{b[0].removeChild(this._canvas),this._canvas.frontLayer&&b[0].removeChild(this._canvas.frontLayer),this._canvas.rearLayer&&b[0].removeChild(this._canvas.rearLayer),this._canvas.contentLayer&&b[0].removeChild(this._canvas.contentLayer),a._jsUnsetMouse(this._mouseInterface)}catch(c){}var e=Math.round(b.width()),h=Math.round(b.height()),j=document.createElement("canvas");j.applet=this;this._canvas=j;j.style.width="100%";j.style.height="100%";j.width=e;j.height=h;j.id=this._id+"_canvas2d";b.append(j);
a._$(j.id).css({"z-index":a._getZ(this,"main")});if(this._isLayered){var l=document.createElement("div");j.contentLayer=l;l.id=this._id+"_contentLayer";b.append(l);a._$(l.id).css({zIndex:a._getZ(this,"image"),position:"absolute",left:"0px",top:"0px",width:(this._isSwing?e:0)+"px",height:(this._isSwing?h:0)+"px",overflow:"hidden"});this._isSwing?(b=document.createElement("div"),b.id=this._id+"_swingdiv",a._$(this._id+"_appletinfotablediv").append(b),a._$(b.id).css({zIndex:a._getZ(this,"rear"),position:"absolute",
left:"0px",top:"0px",width:e+"px",height:h+"px",overflow:"hidden"}),this._mouseInterface=j.contentLayer,j.contentLayer.applet=this):this._mouseInterface=this._getLayer("front",b,e,h,!1)}else this._mouseInterface=j;a._jsSetMouse(this._mouseInterface)};b._getLayer=function(b,c,e,h,j){var l=document.createElement("canvas");this._canvas[b+"Layer"]=l;l.style.width="100%";l.style.height="100%";l.id=this._id+"_"+b+"Layer";l.width=e;l.height=h;c.append(l);l.applet=this;a._$(l.id).css({background:j?"rgb(0,0,0,1)":
...
b._startupScript);a._syncedApplets.length&&c.put("synccallback","Jmol._mySyncCallback");c.put("signedApplet","true");c.put("platform",b._platform);b._is2D&&c.put("display",b._id+"_canvas2d");c.put("documentBase",document.location.href);var e=b._j2sPath+"/";if(0>e.indexOf("://")){var h=document.location.href.split("#")[0].split("?")[0].split("/");0==e.indexOf("/")?h=[h[0],e.substring(1)]:h[h.length-1]=e;e=h.join("/")}c.put("codePath",e);a._registerApplet(b._id,b);try{b._newApplet(c)}catch(j){System.out.println((a._isAsync?
"normal async abort from ":"")+j);return}b._jsSetScreenDimensions();s()};b._restoreState||(b._restoreState=function(){});b._jsSetScreenDimensions=function(){if(this._appletPanel){var b=a._getElement(this,this._is2D?"canvas2d":"canvas");this._appletPanel.setScreenDimension(b.width,b.height)}};b._show=function(b){a.$setVisible(a.$(this,"appletdiv"),b);b&&a._repaint(this,!0)};b._canScript=function(){return!0};b.equals=function(a){return this==a};b.clone=function(){return this};b.hashCode=function(){return parseInt(this._uniqueId)};
b._processGesture=function(a){return this._appletPanel.processTwoPointGesture(a)};b._processEvent=function(a,b){this._appletPanel.processMouseEvent(a,b[0],b[1],b[2],System.currentTimeMillis())};b._resize=function(){var b="__resizeTimeout_"+this._id;a[b]&&clearTimeout(a[b]);var c=this;a[b]=setTimeout(function(){a._repaint(c,!0);a[b]=null},100)};return b};a._repaint=function(b,e){if(b&&b._appletPanel){var h=a.$(b,"appletdiv"),j=Math.round(h.width()),h=Math.round(h.height());if(b._is2D&&(b._canvas.width!=
j||b._canvas.height!=h))b._newCanvas(!0),b._appletPanel.setDisplay(b._canvas);b._appletPanel.setScreenDimension(j,h);j=function(){b._appletPanel.paint?b._appletPanel.paint(null):b._appletPanel.update(null)};e?requestAnimationFrame(j):j()}};a._loadImage=function(b,e,h,j,l,q){var m="echo_"+e+h+(j?"_"+j.length:""),s=a._getHiddenCanvas(b.vwr.html5Applet,m,0,0,!1,!0);if(null==s){if(null==q){q=new Image;if(null==j)return q.onload=function(){a._loadImage(b,e,h,null,l,q)},q.src=h,null;System.out.println("Jsmol.js Jmol._loadImage using data URI for "+
m);q.src="string"==typeof j?j:"data:"+JU.Rdr.guessMimeTypeForBytes(j)+";base64,"+JU.Base64.getBase64(j)}var u=q.width,U=q.height;"webgl"==e&&(u/=2,U/=2);s=a._getHiddenCanvas(b.vwr.html5Applet,m,u,U,!0,!1);s.imageWidth=u;s.imageHeight=U;s.id=m;s.image=q;a._setCanvasImage(s,u,U)}else System.out.println("Jsmol.js Jmol._loadImage reading cached image for "+m);return null==j?l(s,h):s};a._canvasCache={};a._getHiddenCanvas=function(b,e,h,j,l,q){e=b._id+"_"+e;b=a._canvasCache[e];if(q)return b;if(l||!b||b.width!=
h||b.height!=j)b=document.createElement("canvas"),b.width=b.style.width=h,b.height=b.style.height=j,b.id=e,a._canvasCache[e]=b;return b};a._setCanvasImage=function(a,b,e){a.buf32=null;a.width=b;a.height=e;a.getContext("2d").drawImage(a.image,0,0,a.image.width,a.image.height,0,0,b,e)};a._apply=function(a,b){return a(b)}})(Jmol);
(function(a,m){a._Applet=function(e,h,j){window[e]=this;this._jmolType="Jmol._Applet"+(h.isSigned?" (signed)":"");this._viewType="Jmol";this._isJava=!0;this._syncKeyword="Select:";this._availableParams=";progressbar;progresscolor;boxbgcolor;boxfgcolor;allowjavascript;boxmessage;\t\t\t\t\t\t\t\t\t;messagecallback;pickcallback;animframecallback;appletreadycallback;atommovedcallback;\t\t\t\t\t\t\t\t\t;echocallback;evalcallback;hovercallback;language;loadstructcallback;measurecallback;\t\t\t\t\t\t\t\t\t;minimizationcallback;resizecallback;scriptcallback;statusform;statustext;statustextarea;\t\t\t\t\t\t\t\t\t;synccallback;usecommandthread;syncid;appletid;startupscript;menufile;";
if(j)return this;this._isSigned=h.isSigned;this._readyFunction=h.readyFunction;this._ready=!1;this._isJava=!0;this._isInfoVisible=!1;this._applet=null;this._memoryLimit=h.memoryLimit||512;this._canScript=function(){return!0};this._savedOrientations=[];this._initialize=function(e,j){var b=!1;a._jarFile&&(j=a._jarFile);if(this._jarFile){var c=this._jarFile;0<=c.indexOf("/")?(alert("This web page URL is requesting that the applet used be "+c+". This is a possible security risk, particularly if the applet is signed, because signed applets can read and write files on your local machine or network."),
"yes"==prompt("Do you want to use applet "+c+"? ","yes or no")?(e=c.substring(0,c.lastIndexOf("/")),j=c.substring(c.lastIndexOf("/")+1)):b=!0):j=c;this_isSigned=h.isSigned=0<=j.indexOf("Signed")}this._jarPath=h.jarPath=e||".";this._jarFile=h.jarFile="string"==typeof j?j:(j?"JmolAppletSigned":"JmolApplet")+"0.jar";b&&alert("The web page URL was ignored. Continuing using "+this._jarFile+' in directory "'+this._jarPath+'"');void 0==a.controls||a.controls._onloadResetForms()};this._create(e,h);return this};
var j=a._Applet,h=a._Applet.prototype;j._get=function(e,h,q){q||(q=!1);h||(h={});a._addDefaultInfo(h,{color:"#FFFFFF",width:300,height:300,addSelectionOptions:!1,serverURL:"http://your.server.here/jsmol.php",defaultModel:"",script:null,src:null,readyFunction:null,use:"HTML5",jarPath:"java",jarFile:"JmolApplet0.jar",isSigned:!1,j2sPath:"j2s",coverImage:null,makeLiveImage:null,coverTitle:"",coverCommand:"",deferApplet:!1,deferUncover:!1,disableJ2SLoadMonitor:!1,disableInitialConsole:!0,debug:!1});a._debugAlert=
h.debug;h.serverURL&&(a._serverUrl=h.serverURL);for(var m=!1,u=null,b=h.use.toUpperCase().split("#")[0].split(" "),c=0;c<b.length;c++){switch(b[c]){case "JAVA":m=!0;a.featureDetection.supportsJava()&&(u=new j(e,h,q));break;case "WEBGL":u=j._getCanvas(e,h,q,!0);break;case "HTML5":a.featureDetection.allowHTML5?u=j._getCanvas(e,h,q,!1):b.push("JAVA")}if(null!=u)break}null==u&&(q||!m?u={_jmolType:"none"}:m&&(u=new j(e,h)));return q?u:a._registerApplet(e,u)};j._getCanvas=function(e,h,q,m){h._isLayered=
!1;h._platform="J.awtjs2d.Platform";return m&&a.featureDetection.supportsWebGL()?(a._Canvas3D.prototype=a.GLmol.extendApplet(a._jsSetPrototype(new j(e,h,!0))),new a._Canvas3D(e,h,"Jmol",q)):!m?(a._Canvas2D.prototype=a._jsSetPrototype(new j(e,h,!0)),new a._Canvas2D(e,h,"Jmol",q)):null};j._noJavaMsg="Either you do not have Java applets enabled in your web<br />browser or your browser is blocking this applet.<br />\t\t\tCheck the warning message from your browser and/or enable Java applets in<br />\t\t\tyour web browser preferences, or install the Java Runtime Environment from <a href='http://www.java.com'>www.java.com</a>";
j._setCommonMethods=function(a){a._showInfo=h._showInfo;a._search=h._search;a._getName=h._getName;a._readyCallback=h._readyCallback};j._createApplet=function(e,h,q){e._initialize(h.jarPath,h.jarFile);var s=e._jarFile;a._isFile&&(s=s.replace(/0\.jar/,".jar"));var u=0<=e._containerWidth.indexOf("px")?e._containerWidth:"100%",b=0<=e._containerHeight.indexOf("px")?e._containerHeight:"100%",u=' style="width:'+u+";height:"+b+'" ',b="name='"+e._id+"_object' id='"+e._id+"_object' \n"+u+"\n";q.codebase=e._jarPath;
...
h.jarFile);j._createApplet(this,h,q)};h._restoreState=function(e,h){System.out.println("\n\nasynchronous restore state for "+e+" "+h);var j=this,m=j._applet&&j._applet.viewer;switch(h){case "setOptions":return function(){j.__startAppletJS(j)};case "render":return function(){setTimeout(function(){m.refresh(2)},10)};default:switch(e){case "J.shape.Balls":case "J.shape.Sticks":case "J.shape.Frank":return null}if(m&&m.isScriptExecuting&&m.isScriptExecuting()){if(a._asyncCallbacks[e])return System.out.println("...ignored"),
...
this._2dapplet.__showContainer(!0,!0))};h._getSpinner=function(){return this.__Info.appletLoadingImage||this._j2sPath+"/img/JSmol_spinner.gif"};h._getAtomCorrelation=function(a){this._loadMolData(a,"atommap = compare({1.1} {2.1} 'MAP' 'H'); zap 2.1",!0);a=this._evaluate("atommap");for(var h=this._evaluate("{*}.count"),j=[],m=[],u=0;u<a.length;u++){var b=a[u];j[b[0]+1]=b[1]-h+1;m[b[1]-h+1]=b[0]+1}return{fromJmol:j,toJmol:m}};h._show=function(e){var h=!e?2:"100%";a.$setSize(a.$(this,"object"),h,h);
...
function(a){this._applet.syncScript(a)};h._scriptCheck=function(a){return this._ready&&this._applet.scriptCheck(a)};h._scriptWait=function(a,h){var j=this._scriptWaitAsArray(a),m="";if(!h)for(var u=j.length;0<=--u;)for(var b=0,c=j[u].length;b<c;b++)m+=j[u][b]+"\n";return m};h._scriptEcho=function(a){a=this._scriptWaitAsArray(a);for(var h="",j=a.length;0<=--j;)for(var m=a[j].length;0<=--m;)"scriptEcho"==a[j][m][1]&&(h+=a[j][m][3]+"\n");return h.replace(/ \| /g,"\n")};h._scriptMessage=function(a){a=
this._scriptWaitAsArray(a);for(var h="",j=a.length;0<=--j;)for(var m=a[j].length;0<=--m;)"scriptStatus"==a[j][m][1]&&(h+=a[j][m][3]+"\n");return h.replace(/ \| /g,"\n")};h._scriptWaitOutput=function(a){var h="";try{a&&(h+=this._applet.scriptWaitOutput(a))}catch(j){}return h};h._scriptWaitAsArray=function(e){var h="";try{if(this._getStatus("scriptEcho,scriptMessage,scriptStatus,scriptError"),e&&(h+=this._applet.scriptWait(e),h=a._evalJSON(h,"jmolStatus"),"object"==typeof h))return h}catch(j){}return[[h]]};
h._getStatus=function(e){return a._sortMessages(this._getPropertyAsArray("jmolStatus",e))};h._getPropertyAsArray=function(e,h){return a._evalJSON(this._getPropertyAsJSON(e,h),e)};h._getPropertyAsString=function(a,h){void 0==h&&(h="");return this._applet.getPropertyAsString(a,h)+""};h._getPropertyAsJSON=function(a,h){void 0==h&&(h="");try{return this._applet.getPropertyAsJSON(a,h)+""}catch(j){return""}};h._getPropertyAsJavaObject=function(a,h){void 0==h&&(h="");return this._applet.getProperty(a,h)};
...
return!a||""==a?a.replace(/1\.0/,"0"):this._scriptWait(a)};h._restoreOrientationDelayed=function(a,h){1>arguments.length&&(h=1);var j=this._savedOrientations[a];return!j||""==j?j.replace(/1\.0/,h):this._scriptWait(j)};h._resizeApplet=function(e){function h(e,j){var b=""+e;return 0==b.length?j?"":a._allowedJmolSize[2]:b.indexOf("%")==b.length-1?b:1>=(e=parseFloat(e))&&0<e?100*e+"%":(isNaN(e=Math.floor(e))?a._allowedJmolSize[2]:e<a._allowedJmolSize[0]?a._allowedJmolSize[0]:e>a._allowedJmolSize[1]?a._allowedJmolSize[1]:
e)+(j?j:"")}var j;"object"==typeof e&&null!=e?(j=e[0]||e.width,e=e[1]||e.height):j=e;j=[h(j,"px"),h(e,"px")];e=a._getElement(this,"appletinfotablediv");e.style.width=j[0];e.style.height=j[1];this._containerWidth=j[0];this._containerHeight=j[1];this._is2D&&a._repaint(this,!0)};h._search=function(e,h){a._search(this,e,h)};h._searchDatabase=function(e,h,j){if(this._2dapplet&&this._2dapplet._isEmbedded&&!a.$(this,"appletdiv:visible")[0])return this._2dapplet._searchDatabase(e,h,j);this._showInfo(!1);
0<=e.indexOf("?")?a._getInfoFromDatabase(this,h,e.split("?")[0]):(j||(j=a._getScriptForDatabase(h)),e=h+e,this._currentView=null,this._searchQuery=e,this._loadFile(e,j,e))};h._loadFile=function(e,h,j){this._showInfo(!1);h||(h="");this._thisJmolModel=""+Math.random();this._fileName=e;if(!this._scriptLoad(e,h)){var m=this;a._loadFileData(this,e,function(a){m.__loadModel(a,h,j)},function(){m.__loadModel(null)})}};h._scriptLoad=function(a,h){h||(h="");var j=this._isJava||!this._noscript;j&&this._script("zap;set echo middle center;echo Retrieving data...");
if(!this._isSigned||null!=this._viewSet)return!1;j?this._script('load async "'+a+'";'+h):this._applet.openFile(a);this._checkDeferred("");return!0};h.__loadModel=function(e,h,j){null!=e&&(null!=this._viewSet&&(h||(h=""),h+=";if ({*}.molecule.max > 1 || {*}.modelindex.max > 0){ delete molecule > 1 or modelindex > 0;x = getProperty('extractModel',{*});load inline @x};"),!h&&this._noscript?this._applet.loadInlineString(e,"",!1):this._loadMolData(e,h,!1),null!=this._viewSet&&a.View.updateView(this,{chemID:j,
data:e}))};h._loadMolData=function(a,h,j){h||(h="");j=j?"append":"model";this._applet.scriptWait('load DATA "'+j+'"'+a+'\nEND "'+j+'" ;'+h)};h._loadModelFromView=function(e){this._currentView=e;var h=e.Jmol;null!=h.data?this.__loadModel(h.data,null,e.info.chemID):null!=e.info.chemID?a._searchMol(this,e.info.chemID,null,!1):(h=e.JME)&&h.applet._show2d(!1,this)};h._updateView=function(){null!=this._viewSet&&this._applet&&(chemID=""+this._getPropertyAsJavaObject("variableInfo","script('show chemical inchiKey')"),
chemID=36>chemID.length()?null:chemID.substring(36).split("\n")[0],a.View.updateView(this,{chemID:chemID,data:""+this._getPropertyAsJavaObject("evaluate","extractModel","{visible}")}))};h._atomPickedCallback=function(e,h){if(!(0>h)){var j=[h+1];a.View.updateAtomPick(this,j);this._updateAtomPick(j)}};h._updateAtomPick=function(a){this._script(0==a.length?"select none":"select on visible and (@"+a.join(",@")+")")};h._isDeferred=function(){return!this._canvas&&this._cover&&this._isCovered&&this._deferApplet};
...
m._previousOnloadHandler&&m._previousOnloadHandler()})};m._getButton=function(j,h,e,l,q){j=m._getIdForControl(j,h);if(null==j)return"";void 0!=l&&null!=l||(l="jmolButton"+m._buttonCount);void 0!=e&&null!=e||(e=h.substring(0,32));++m._buttonCount;m._actions[l]=m._addScript(j,h);h='<span id="span_'+l+'"'+(q?' title="'+q+'"':"")+"><input type='button' name='"+l+"' id='"+l+"' value='"+e+"' onclick='Jmol.controls._click(this)' onmouseover='Jmol.controls._mouseOver(this);return true' onmouseout='Jmol.controls._mouseOut()' "+
m._buttonCssText+" /></span>";a._debugAlert&&alert(h);return a._documentWrite(h)};m._getCheckbox=function(j,h,e,l,q,s,u){var b=m._getIdForControl(j,h);null!=b&&(b=m._getIdForControl(j,e));if(null==b)return"";void 0!=s&&null!=s||(s="jmolCheckbox"+m._checkboxCount);++m._checkboxCount;if(void 0==h||null==h||void 0==e||null==e)alert("jmolCheckbox requires two scripts");else if(void 0==l||null==l)alert("jmolCheckbox requires a label");else return m._actions[s]=[m._addScript(b,h),m._addScript(b,e)],j="</span>",
q='<span id="span_'+s+'"'+(u?' title="'+u+'"':"")+"><input type='checkbox' name='"+s+"' id='"+s+"' onclick='Jmol.controls._cbClick(this)' onmouseover='Jmol.controls._cbOver(this);return true' onmouseout='Jmol.controls._mouseOut()' "+(q?"checked='true' ":"")+m._checkboxCssText+" />",0<=l.toLowerCase().indexOf("<td>")&&(q+=j,j=""),q+='<label for="'+s+'">'+l+"</label>"+j,a._debugAlert&&alert(q),a._documentWrite(q)};m._getCommandInput=function(j,h,e,l,q,s){j=m._getIdForControl(j,"x");if(null==j)return"";
void 0!=l&&null!=l||(l="jmolCmd"+m._cmdCount);void 0!=h&&null!=h||(h="Execute");void 0!=e&&!isNaN(e)||(e=60);void 0!=s||(s="help");++m._cmdCount;h='<span id="span_'+l+'"'+(q?' title="'+q+'"':"")+"><input name='"+l+"' id='"+l+"' size='"+e+"' onkeydown='return Jmol.controls._commandKeyPress(event,\""+l+'","'+j+"\")' value='"+s+"'/><input  type='button' name='"+l+"Btn' id='"+l+"Btn' value = '"+h+"' onclick='Jmol.controls._commandKeyPress(13,\""+l+'","'+j+"\")' /></span>";a._debugAlert&&alert(h);return a._documentWrite(h)};
m._getLink=function(j,h,e,l,q){j=m._getIdForControl(j,h);if(null==j)return"";void 0!=l&&null!=l||(l="jmolLink"+m._linkCount);void 0!=e&&null!=e||(e=h.substring(0,32));++m._linkCount;h=m._addScript(j,h);e='<span id="span_'+l+'"'+(q?' title="'+q+'"':"")+"><a name='"+l+"' id='"+l+"' href='javascript:Jmol.controls._click(null,"+h+");' onmouseover='Jmol.controls._mouseOver(null,"+h+");return true;' onmouseout='Jmol.controls._mouseOut()' "+m._linkCssText+">"+e+"</a></span>";a._debugAlert&&alert(e);return a._documentWrite(e)};
m._getMenu=function(j,h,e,l,q){var s=m._getIdForControl(j,null);void 0!=l&&null!=l||(l="jmolMenu"+m._menuCount);++m._menuCount;s=typeof h;if(null!=s&&"object"==s&&h.length){var u=h.length;"number"!=typeof e||1==e?e=null:0>e&&(e=u);e='<span id="span_'+l+'"'+(q?' title="'+q+'"':"")+"><select name='"+l+"' id='"+l+"' onChange='Jmol.controls._menuSelected(this)'"+(e?" size='"+e+"' ":"")+m._menuCssText+">";for(l=0;l<u;++l){var b=h[l],s=typeof b,c=null,d=q=null;"object"==s&&null!=b?(c=b[0],q=b[1],d=b[2]):
c=q=b;s=m._getIdForControl(j,c);if(null==s)return"";null==q&&(q=c);"#optgroup"==c?e+="<optgroup label='"+q+"'>":"#optgroupEnd"==c?e+="</optgroup>":(s=m._addScript(s,c),e+="<option value='"+s+(d?"' selected='true'>":"'>")+q+"</option>")}e+="</select></span>";a._debugAlert&&alert(e);return a._documentWrite(e)}};m._getRadio=function(j,h,e,l,q,s,u,b){0==m._radioGroupCount&&++m._radioGroupCount;s||(s="jmolRadioGroup"+(m._radioGroupCount-1));j=m._radio(j,h,e,l,q,s,u?u:s+"_"+m._radioCount,b?b:0);if(null==
j)return"";a._debugAlert&&alert(j);return a._documentWrite(j)};m._getRadioGroup=function(j,h,e,l,q,s){var u=typeof h;if("object"!=u||null==u||!h.length)alert("invalid arrayOfRadioButtons");else{void 0!=e&&null!=e||(e="&#xa0; ");var b=h.length;++m._radioGroupCount;l||(l="jmolRadioGroup"+(m._radioGroupCount-1));for(var c="<span id='"+(q?q:l)+"'>",d=0;d<b;++d){d==b-1&&(e="");var t=h[d],u=typeof t,F=null,c="object"==u?c+(F=m._radio(j,t[0],t[1],t[2],e,l,3<t.length?t[3]:(q?q:l)+"_"+d,4<t.length?t[4]:0,
s)):c+(F=m._radio(j,t,null,null,e,l,(q?q:l)+"_"+d,s));if(null==F)return""}c+="</span>";a._debugAlert&&alert(c);return a._documentWrite(c)}}})(Jmol);
(function(a){var m=function(a){a="&"+a+"=";return decodeURI(("&"+document.location.search.substring(1)+a).split(a)[1].split("&")[0])};a._j2sPath=m("_J2S");a._jarFile=m("_JAR");a._use=m("_USE");a.getVersion=function(){return a._jmolInfo.version};a.getApplet=function(j,h,e){return a._Applet._get(j,h,e)};a.getJMEApplet=function(j,h,e,l){return a._JMEApplet._get(j,h,e,l)};a.getJSVApplet=function(j,h,e){return a._JSVApplet._get(j,h,e)};a.loadFile=function(a,h,e){a._loadFile(h,e)};a.script=function(a,h){a._checkDeferred(h)||
...
a.jmolButton=function(j,h,e,l,m){return a.controls._getButton(j,h,e,l,m)};a.jmolCheckbox=function(j,h,e,l,m,s,u){return a.controls._getCheckbox(j,h,e,l,m,s,u)};a.jmolCommandInput=function(j,h,e,l,m,s){return a.controls._getCommandInput(j,h,e,l,m,s)};a.jmolHtml=function(j){return a._documentWrite(j)};a.jmolLink=function(j,h,e,l,m){return a.controls._getLink(j,h,e,l,m)};a.jmolMenu=function(j,h,e,l,m){return a.controls._getMenu(j,h,e,l,m)};a.jmolRadio=function(j,h,e,l,m,s,u,b){return a.controls._getRadio(j,
h,e,l,m,s,u,b)};a.jmolRadioGroup=function(j,h,e,l,m,s){return a.controls._getRadioGroup(j,h,e,l,m,s)};a.setCheckboxGroup=function(j,h){a.controls._cbSetCheckboxGroup(j,h,arguments)};a.setDocument=function(j){a._document=j};a.setXHTML=function(j){a._isXHTML=!0;a._XhtmlElement=null;a._XhtmlAppendChild=!1;j&&(a._XhtmlElement=document.getElementById(j),a._XhtmlAppendChild=!0)};a.setAppletCss=function(j,h){null!=j&&(a._appletCssClass=j);a._appletCssText=h?h+" ":j?'class="'+j+'" ':""};a.setButtonCss=function(j,
h){null!=j&&(a.controls._buttonCssClass=j);a.controls._buttonCssText=h?h+" ":j?'class="'+j+'" ':""};a.setCheckboxCss=function(j,h){null!=j&&(a.controls._checkboxCssClass=j);a.controls._checkboxCssText=h?h+" ":j?'class="'+j+'" ':""};a.setRadioCss=function(j,h){null!=j&&(a.controls._radioCssClass=j);a.controls._radioCssText=h?h+" ":j?'class="'+j+'" ':""};a.setLinkCss=function(j,h){null!=j&&(a.controls._linkCssClass=j);a.controls._linkCssText=h?h+" ":j?'class="'+j+'" ':""};a.setMenuCss=function(j,h){null!=
j&&(a.controls._menuCssClass=j);a.controls._menuCssText=h?h+" ":j?'class="'+j+'" ':""};a.setAppletSync=function(j,h,e){a._syncedApplets=j;a._syncedCommands=h;a._syncedReady={};a._isJmolJSVSync=e};a.setGrabberOptions=function(j){a._grabberOptions=j};a.setAppletHtml=function(j,h){j._code&&(a.$html(h,j._code),j._init&&!j._deferApplet&&j._init())};a.coverApplet=function(a,h){a._cover&&a._cover(h)};a.setFileCaching=function(j,h){j?j._cacheFiles=h:a.fileCache=h?{}:null};a.updateView=function(a,h,e){a._updateView(h,
e)};a.getChemicalInfo=function(j,h,e){h||(h="name");"string"!=typeof j&&(j=j._getSmiles());return a._getNCIInfo(j,h,e)};a.saveImage=function(a){switch(a._viewType){case "Jmol":a._script('write PNGJ "'+a._id+'.png"');break;case "JSV":a._script("write PDF");break;case "JME":a._script("print")}}})(Jmol);
LoadClazz=function(){c$=null;window["j2s.clazzloaded"]||(window["j2s.clazzloaded"]=!1);window["j2s.clazzloaded"]||(window["j2s.clazzloaded"]=!0,window["j2s.object.native"]=!0,Clazz={_isQuiet:!1,_debugging:!1},function(a,m){try{a._debugging=0<=document.location.href.indexOf("j2sdebug")}catch(j){}var h=["j2s.clazzloaded","j2s.object.native"];a.setGlobal=function(a,b){h.push(a);window[a]=b};a.getGlobals=function(){return h.sort().join("\n")};a.setConsoleDiv=function(a){window["j2s.lib"]&&(window["j2s.lib"].console=
...
(b.con$truct.index=b.con$truct.stacks.length)};a.overrideConstructor=function(b,c,d){a.overrideMethod(b,"construct",c,d);b.con$truct&&(b.con$truct.index=b.con$truct.stacks.length)};a.defineMethod=function(c,d,h,j){h.exName=d;j=Ea(j);var l=c.prototype,m=l[d];a._Loader._checkLoad&&K(c,d,j);if(!m||m.claxxOwner===c&&m.funParams==j)return h.funParams=j,h.claxxOwner=c,h.exClazz=c,l[d]=h;var q=null,s=m.stacks;s||(s=[],q=m,m.claxxOwner&&(s[0]=q.claxxOwner));if(!m.stacks||m.claxxReference!==c){++Q;m=function(){var c;
a:{var k=arguments.callee.claxxReference,d=arguments.callee.methodName;c=arguments;fx=this[d];var h=a.getParamsType(c);if(!fx)try{System.out.println(a.getStackTrace(5))}catch(n){}if(e){var j=k.__CLASS_NAME__+" "+d+" ";0>U.indexOf(j)&&(U+=j+"\n");e[j]||(e[j]=0);e[j]++}if(fx.lastParams==h.typeString&&fx.lastClaxxRef===k){if(h.hasCastedNull){k=[];for(d=0;d<c.length;d++)k[d]=c[d]instanceof a.CastedNull?null:c[d]}else k=c;c=fx.lastMethod?fx.lastMethod.apply(this,k):null}else{fx.lastParams=h.typeString;
fx.lastClaxxRef=k;j=fx.stacks;j||(j=k.prototype[d].stacks);for(var r=!1,l=j.length;0<=--l;)if(r||j[l]===k){var m=j[l].prototype[d],A=h,r=c,q=fx,s=[],t=!0,G=void 0;for(G in m)if(92==G.charCodeAt(0)){var u=G.substring(1).split("\\");u.length==A.length&&s.push(u);t=!1}else if(t&&"funParams"==G&&m.funParams){G=m.funParams;u=G.substring(1).split("\\");u.length==A.length&&(s[0]=u);break}G=void 0;if(!(G=0==s.length)){G=void 0;for(var G=[],P=s.length,u=0;u<P;u++){for(var x=[],za=!0,D=s[u].length,C=0;C<D;C++)if(x[C]=
a.getInheritedLevel(A[C],s[u][C]),0>x[C]){za=!1;break}za&&(x[A.length]=u,G.push(x))}if(0==G.length)G=null;else{P=G[0];for(u=1;u<G.length;u++){x=!0;for(C=0;C<A.length;C++)if(P[C]<G[u][C]){x=!1;break}x&&(P=G[u])}G=s[P[A.length]].join("\\")}G=!(s=G)}if(G)r=new b;else{m=t?m:m["\\"+s];t=null;if(A.hasCastedNull){t=[];for(A=0;A<r.length;A++)t[A]=r[A]instanceof a.CastedNull?null:r[A]}else t=r;q.lastMethod=m;r=m.apply(this,t)}if(!(r instanceof b)){c=r;break a}r=!0}"construct"!=d&&fb(this,k,d,h.typeString);
c=void 0}}return c};m.methodName=d;m.claxxReference=c;m=l[d]=m;d=[];for(l=0;l<s.length;l++)d[l]=s[l];m.stacks=d}s=m.stacks;0>rb(s,c)&&s.push(c);q&&(q.claxxOwner===c?(m[q.funParams]=q,q.claxxOwner=null,q.funParams=null):q.claxxOwner||(m["\\unknown"]=q));h.exClazz=c;m[j]=h;return m};duplicatedMethods={};var K=function(b,c,d){var e=b.prototype[c];if(e&&(e.claxxOwner||e.claxxReference)===b)key=b.__CLASS_NAME__+"."+c+d,(b=duplicatedMethods[key])?(c="Warning! Duplicate method found for "+key,System.out.println(c),
...
a.getParamsType=function(b){var c=b.length;switch(c){case 0:var d=["void"];d.typeString="\\void";return d;case 1:switch(typeof obj){case "number":return d=["n"],d.typeString="\\n",d;case "boolean":return d=["b"],d.typeString="\\b",d}}d=[];d.hasCastedNull=!1;if(b)for(var e=0;e<c;e++)d[e]=a.getClassName(b[e]),b[e]instanceof a.CastedNull&&(d.hasCastedNull=!0);d.typeString="\\"+d.join("\\");return d};var Q=0;a.allPackage={};a.allClasses={};a.lastPackageName=null;a.lastPackage=null;a.unloadedClasses=[];
...
"/"),e=c.length,e=c.charAt(e-1);"/"!=e&&(c+="/");d=c+b.substring(1)}else d=b.substring(1);else{if(this.base)c=this.base;else if(a._Loader)if(c=a._Loader.getClasspathFor(d),e=c.lastIndexOf(d.replace(/\./g,"/")),-1!=e)c=c.substring(0,e);else if(e=-1,c.indexOf(".z.js")==c.length-5&&-1!=(e=c.lastIndexOf("/")))for(var c=c.substring(0,e+1),e=d.split(/\./),h=1;h<e.length;h++){for(var j="/",l=0;l<h;l++)j+=e[l]+"/";if(j.length>c.length)break;if(c.indexOf(j)==c.length-j.length){c=c.substring(0,c.length-j.length+
...
};a.prepareCallback=function(b,c){var d=c[0];if(b&&d&&d!==window){var e=a.getClassName(d,!0),h={};if(b.b$)for(var j in b.b$)h[j]=b.b$[j];b.b$=h;h[e]=d;for(e=a.getClass(d);e.superClazz;)e=e.superClazz,h[a.getClassName(e,!0)]=d;if(d=d.b$)for(j in d)h[j]=d[j]}for(h=0;h<c.length-1;h++)c[h]=c[h+1];c.length--};a.innerTypeInstance=function(b,c,d){b||(b=arguments.callee.caller);var e;if(d||c.$finals)if(e=new b(c,a.inheritArgs),d)if(c.f$){var h={},j;for(j in c.f$)h[j]=c.f$[j];for(j in d)h[j]=d[j];e.f$=h}else e.f$=
...
a.readyState){try{a.parentNode&&a.parentNode.removeChild(a)}catch(b){}a=null}}},Z=function(a){window["j2s.script.debugging"]||window.setTimeout(aa(a),1)};a._4Name=function(c,d,e){if(a.isClassDefined(c))return a.evalType(c);d=m._isAsync&&d?d._restoreState(c,e):null;if(1==d)return null;if(b.setLoadingMode(d?b.MODE_SCRIPT:"xhr.sync"))return b.loadClass(c,d,!1,!0,1),null;b.loadClass(c);return a.evalType(c)};a.currentPath="";var V=function(c,d,g,j,l){a.currentPath=d;j&&alert("WHY>>");j=e[d];e[d]=!0;Ya(F,
d);M=!0;ra=!1;b._checkLoad&&System.out.println("\t"+d+(g?"\n -- required by "+g:"")+"  ajax="+M+" async="+ra);g=d;a._debugging&&(d=d.replace(/\.z\.js/,".js"));j||System.out.println("loadScript "+d);b.onScriptLoading(d);if(M&&!ra){var r=m._getFileData(d);try{U(d,g,r,j)}catch(q){alert(q+" loading file "+d+" "+c.name+" "+a.getStackTrace())}l&&l()}else c={dataType:"script",async:!0,type:"GET",url:d,success:ta(d,!1,l),error:ta(d,!0,l)},h++,j?setTimeout(c.success,0):m.$ajax(c)},ta=function(c,d,e){a.getStackTrace();
return function(){g&&this.timeoutHandle&&(window.clearTimeout(this.timeoutHandle),this.timeoutHandle=null);0<h&&h--;this.onerror=this.onload=null;d&&alert("There was a problem loading "+c);b.onScriptLoaded(c,!0);var a=this,k;k=e?function(){Z(a);sa(c,e)}:function(){Z(a);sa(c)};0<=W?window.setTimeout(function(){sa(c,k)},W):sa(c,k)}},ga=!0,fa=!1,sa=function(c,g){var l=L["@"+c];if(l){var m,r=E["$"+c];if(r)for(var q=0;q<r.length;q++){var t=r[q];if(t!=l.name&&(m=I(t)))m.status<x.STATUS_CONTENT_LOADED&&
...
for(q=0;q<r.length;q++)if(s){if(r[q].onreadystatechange&&r[q].onreadystatechange.path==l.path&&"interactive"==r[q].readyState){m=!0;break}}else if(r[q].onload&&r[q].onload.path==l.path){m=!0;break}m||(l.status=x.STATUS_CONTENT_LOADED,updateNode(l))}if(b.keepOnLoading){q=!0;if(m=Ka(x.STATUS_KNOWN))for(S(m);h<j&&(m=Ka(x.STATUS_KNOWN));)S(m);else if(0!=F.length)m=F.shift(),!e[m.path]||0!=F.length||!ga||m.musts.length||m.optionals.length?(Ja(d,m,!0),V(m,m.path,m.requiredBy,!1)):ga&&(ga=!1);else if(m=
H(x.STATUS_KNOWN))for(S(m);h<j&&(m=H(x.STATUS_KNOWN));)S(m);else q=!1;if(!(q||0<h)){l=[Ka,H];r=null;for(q=0;2>q;q++)for(;m=l[q](x.STATUS_CONTENT_LOADED);)1==q&&r===m&&(m.status=x.STATUS_LOAD_COMPLETE),updateNode(m),r=m;for(;!(la=[],!ma(d,c)););for(q=0;2>q;q++)for(r=null;(m=l[q](x.STATUS_DECLARED))&&r!==m;)updateNode(r=m);r=[];for(q=0;2>q;q++)for(;m=l[q](x.STATUS_DECLARED);)r.push(m),m.status=x.STATUS_LOAD_COMPLETE;if(r.length){for(q=0;q<r.length;q++)Da(r[q]);for(q=0;q<r.length;q++)if(l=r[q].onLoaded)r[q].onLoaded=
null,l()}if(g)g();else if(b._classCountPending)for(t in b._classPending){if(m=I(t),System.out.println("class left pending "+t+" "+m),m){updateNode(m);break}}else b._checkLoad&&(System.out.println("I think I'm done: SAEM call count: "+Q),a.showDuplicates(!0));b.onGlobalLoaded()}}}},la=[],ma=function(a,c){var d=la,e=d.length;d.push(a);for(var g=e;0<=--g&&!(d[g]===a&&d[g].status>=x.STATUS_DECLARED););if(0<=g){if(b._checkLoad){var h;System.out.println("cycle found loading "+c+" for "+a)}for(;g<e;g++){var k=
d[g];k.status=x.STATUS_LOAD_COMPLETE;Da(k);for(h=0;h<k.parents.length;h++)updateNode(k.parents[h]);k.parents=[];var j=k.onLoaded;b._checkLoad&&(h="cycle setting status to LOAD_COMPLETE for "+k.name+(j?" firing "+j.toString():""),System.out.println(h));j&&(k.onLoaded=null,j())}d.length=0;return!0}k=[a.musts,a.optionals];for(h=0;2>h;h++){j=k[h];for(g=j.length;0<=--g;)if(j[g].status==x.STATUS_DECLARED&&ma(j[g],c))return!0}d.length=e;return!1};b._classCountPending=0;b._classCountOK=0;b._classPending=
...
function(a){D.consoleOutput(a,"red")};aa.err.println=function(a){D.consoleOutput("undefined"==typeof a?"\r\n":null==a?"null\r\n":a+"\r\n","red")};aa.err.write=function(a,b,c){aa.err.print(String.instantialize(a).substring(b,b+c))}}(Clazz,Jmol))};Jmol.___JmolDate="$Date: 2016-05-27 00:11:00 -0500 (Fri, 27 May 2016) $";Jmol.___fullJmolProperties="src/org/jmol/viewer/Jmol.properties";Jmol.___JmolVersion="14.6.0_2016.05.26";Jmol.___JmolVersion="14.6.0_2016.05.24";
