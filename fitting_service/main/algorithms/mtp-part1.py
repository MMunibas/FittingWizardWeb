...
#from fitting_service.settings import gau_formchk, gdma
...
def mtpfit_part1(ctx):
    ...
    ctx.create_gau_submission_script("run-gau.sh", gau_inp_file, gau_out_name, "mtp", chk_name, fchk_name, gdma_inp_name, gdma_out_name, grid_pars, cube_file, pun_name, vdw_file_name, xyz_file_name, sdf_file_name, ncore)
